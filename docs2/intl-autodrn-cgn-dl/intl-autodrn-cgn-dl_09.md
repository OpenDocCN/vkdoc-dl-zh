...
+   将策略映射到动作
    ...
    +   根据代理的状态和遵循的策略提供奖励
        ...
        +   ![$$ {V}_{\pi }(s)={\mathbbm{E}}_{\pi}\left[{G}_t|{S}_t=s\right] $$](../images/494112_1_En_9_Chapter/494112_1_En_9_Chapter_TeX_IEq1.png) (衡量状态的好坏)

        +   ![$$ {Q}_{\pi}\left(s,a\right)={\mathbbm{E}}_{\pi}\left[{G}_t|{S}_t=s,{A}_t=a\right] $$](../images/494112_1_En_9_Chapter/494112_1_En_9_Chapter_TeX_IEq2.png) (衡量采取动作的好坏)

        +   如果使用表格 *Q*-学习，估计新的 *Q*-值：

            ![$$ New\ Q\left(S,A\right)\longleftarrow Q\left(S,A\right)+\alpha \left[{R}^{\prime }+\gamma \underset{a}{\max }{Q}^{\prime}\left({S}^{\prime },a\right)-Q\left(S,A\right)\right] $$](../images/494112_1_En_9_Chapter/494112_1_En_9_Chapter_TeX_Equa.png)
