...
![$$ \underset{\theta }{\mathit{\max}}\ J\left(\theta, D\right)=\underset{\theta }{\mathit{\max}}\underset{s\sim D}{E}\left[{Q}_{\upphi}\left(s,{\upmu}_{\uptheta}(s)\right)\right] $$](img/502835_2_En_9_Chapter/502835_2_En_9_Chapter_TeX_Equ7.png)
...
![J(θ)=E_x~p_θ(x)[x²]](img/502835_2_En_9_Chapter/502835_2_En_9_Chapter_TeX_Eque.png)
...
![公式 Var\left({\nabla}_{\uptheta}\hat{\mathrm{J}}\left(\uptheta \right)\right)=\frac{1}{\mathrm{N}}\left[{\upmu}⁶+15{\upmu}⁴{\upsigma}²+45{\upmu}²{\upsigma}⁴+15{\upsigma}⁶+{\uptheta}²\left({\upmu}⁴+6{\upmu}²{\upsigma}²+3{\upsigma}⁴\right)-2.\uptheta \left({\upmu}⁵+10{\upmu}³{\upsigma}²+15\upmu {\upsigma}⁴\right)-{\left({\upmu}³+3\upmu {\upsigma}²-\uptheta .\left({\upmu}²+{\upsigma}²\right)\right)}²\right] ](img/502835_2_En_9_Chapter/502835_2_En_9_Chapter_TeX_Equaj.png)

将 μ = θ = 2 和 σ = 1 代入，得到：

![公式 Var\left({\nabla}_{\uptheta}\hat{J}\left(\uptheta \right)\right)=\frac{1}{N}\left[{2}⁶+{15.2}⁴+{45.2}²+15+4\left({2}⁴+{6.2}²+3\right)-4\left({2}⁵+{10.2}³+15.2\right)-{\left({2}³+3.2-2\left({2}²+1\right)\right)}²\right] ](img/502835_2_En_9_Chapter/502835_2_En_9_Chapter_TeX_Equak.png)

![公式 =\frac{1}{N}\left[64+240+180+15+4\left(16+6.4+3\right)-4\left(32+10.8+15.2\right)-{\left(8+3.2-2\left(4+1\right)\right)}²\right] ](img/502835_2_En_9_Chapter/502835_2_En_9_Chapter_TeX_Equal.png)

![公式 =\frac{1}{N}\left[64+240+180+15+4\left(16+6.4+3\right)-4\left(32+10.8+15.2\right)-{\left(8+3.2-2\left(4+1\right)\right)}²\right] ](img/502835_2_En_9_Chapter/502835_2_En_9_Chapter_TeX_Equam.png)
...
![公式 \mathrm{E}\left[{\nabla}_{\uptheta}\hat{J}\left(\uptheta \right)\right]=\mathrm{E}\left[\frac{1}{N}{\sum}_{i=1}^N2\left(\uptheta +{\upvarepsilon}_i\right)\right] ](img/502835_2_En_9_Chapter/502835_2_En_9_Chapter_TeX_Equao.png)

注意，在重新参数化后，现在有 ϵ[*i*] ∼ *N*(0, 1) 且 θ 是一个等于 2 的常数。

![公式 \mathrm{E}\left[{\nabla}_{\uptheta}\hat{J}\left(\uptheta \right)\right]=\frac{1}{N}{\sum}_{i=1}^N2E\left[\left(\uptheta +{\upvarepsilon}_i\right)\right] ](img/502835_2_En_9_Chapter/502835_2_En_9_Chapter_TeX_Equap.png)

![公式 =\frac{1}{N}{\sum}_{i=1}^N2.\uptheta ](img/502835_2_En_9_Chapter_TeX_Equaq.png)

![公式 \mathrm{E}\left[{\nabla}_{\uptheta}\hat{J}\left(\uptheta \right)\right]=2.\uptheta =4 ](img/502835_2_En_9_Chapter/502835_2_En_9_Chapter_TeX_Equar.png)
...
![$$ H(P)=\underset{x\sim P}{E}\left[- logP(x)\right] $$](img/502835_2_En_9_Chapter/502835_2_En_9_Chapter_TeX_Equ20.png)
...
![π∗=argmaxπEτ~π[∑t=0∞γt(R(st,at,st+1)+αH(π(⋅|st)))]](img/502835_2_En_9_Chapter/502835_2_En_9_Chapter_TeX_Equ21.png)

(9-20)

在这种设置下，*V*^(*π*) 被修改为包含每个时间步的熵。

![Vπ(s)=Eτ~π[∑t=0∞γt(R(st,at,st+1)+αH(π(⋅|st)))|s0=s]](img/502835_2_En_9_Chapter/502835_2_En_9_Chapter_TeX_Equ22.png)

(9-21)

此外，*Q*^(*π*) 被修改为除了第一个时间步之外，包含每个时间步的熵奖励。

![Qπ(s,a)=Eτ~π[∑t=0∞γtR(st,at,st+1)+α∑t=1∞γtH(π(⋅|st))]|s0=s,a0=a](img/502835_2_En_9_Chapter/502835_2_En_9_Chapter_TeX_Equ23.png)

(9-22)

在这些定义下，*V*^(*π*) 和 *Q*^(*π*) 通过以下关系相连：

![Vπ(s)=E[a~π[Qπ(s,a)+αH(π(⋅|s))]]](img/502835_2_En_9_Chapter/502835_2_En_9_Chapter_TeX_Equ24.png)

(9-23)

*Q*^(*π*) 的 Bellman 方程如下：

![Qπ(s,a)=E[s′~P,a′~π[R(s,a,s′)+γ(Qπ(s′,a′)+αH(π(⋅|s′)))]=E[s′~P[R(s,a,s′)+γVπ(s′)]]](img/502835_2_En_9_Chapter/502835_2_En_9_Chapter_TeX_Equ25.png)
