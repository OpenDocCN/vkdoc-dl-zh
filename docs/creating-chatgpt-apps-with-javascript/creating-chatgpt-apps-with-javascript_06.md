...
Maximum Length: 1150
清单 5-4
提示：要求 ChatGPT 使用 OpenAI 的 JavaScript 库并将 MP3 文件发送到 Whisper 的 API
```
...
![](img/625846_1_En_5_Fig2_HTML.jpg)
