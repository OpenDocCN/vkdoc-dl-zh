...
![img/494424_1_En_1_Chapter/494424_1_En_1_Fig1_HTML.jpg](img/494424_1_En_1_Fig1_HTML.jpg)
...
![img/494424_1_En_1_Chapter/494424_1_En_1_Fig2_HTML.jpg](img/494424_1_En_1_Fig2_HTML.jpg)
...
const dense1 = tf.layers.dense({ units: 10, activation: 'sigmoid' }).apply(input);
...
function opModel() {
  ...
  const model = (x) =>
    x.matMul(w1).add(b1).sigmoid().matMul(w2).add(b2).softmax();
}
```
