...
![图 5-1：协同过滤的两种方法类型](img/537881_1_En_5_Fig1_HTML.png)
...
![图 5-2：输入数据](img/537881_1_En_5_Fig2_HTML.png)

数据框展示了包含发票号、库存代码、数量、发票日期、交货日期、折扣百分比、运输方式、运输成本和客户 `ID` 的输入数据。

让我们重用第四章中的 `items_purchase_df`。它是一个包含项目和客户是否购买它们的信息的矩阵。
...
![图 5-3：项目购买数据框/矩阵](img/537881_1_En_5_Fig3_HTML.png)
...
![图 5-4：堆叠的项目购买数据框/矩阵](img/537881_1_En_5_Fig4_HTML.jpg)
...
以下导入 `Counter` 以计算每个客户和每个项目的订单数量。
...
![图 5-5：客户计数数据框](img/537881_1_En_5_Fig5_HTML.jpg)
...
![图 5-6：项目计数数据框](img/537881_1_En_5_Fig6_HTML.jpg)
...
![图 5-7：最终的短名单数据框](img/537881_1_En_5_Fig7_HTML.jpg)
...
![图 5-8：描述短名单数据框](img/537881_1_En_5_Fig8_HTML.jpg)
...
![图 5-9：矩阵分解](img/537881_1_En_5_Fig9_HTML.png)
...
![图 5-10：`NMF` 的交叉验证输出](img/537881_1_En_5_Fig10_HTML.jpg)

表示展示了 `NMF` 的交叉验证结果。展示了算法 `NMF` 在 5 次分割上的 `RMSE`、`MAE` 评估。
...
![图 5-11：协同聚类的交叉验证输出](img/537881_1_En_5_Fig11_HTML.jpg)
...
![图 5-12：`SVD` 的交叉验证输出](img/537881_1_En_5_Fig12_HTML.jpg)
...
![图 5-13 预测 DataFrame](img/537881_1_En_5_Fig13_HTML.png)
...
![图 5-14 最佳预测](img/537881_1_En_5_Fig14_HTML.png)
...
![图 5-15 最差预测](img/537881_1_En_5_Fig15_HTML.png)
