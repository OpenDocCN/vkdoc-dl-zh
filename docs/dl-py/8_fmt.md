...
计算机视觉图像中的物体检测来源-[`github.com/facebookresearch/Detectron2`](https://github.com/facebookresearch/Detectron2)
...
计算机视觉中的图像分割图片来源-[`github.com/facebookresearch/Detectron2`](https://github.com/facebookresearch/Detectron2)
...
多人姿势估计图片来源-[`github.com/facebookresearch/Detectron2`](https://github.com/facebookresearch/Detectron2)
...
gan 的实际应用是无限的。最简单的应用程序是基于文本描述渲染图像的产品。例如，键入“设计一个白天人比车多的繁忙街道的图像”将得到显示这些事情的图像。反之亦然——即，输入图像并接收关于该图像的基于文本的自然语言描述。科技公司百度设计了一种原型设备，它通过一个用自然语言描述周围环境的摄像头来帮助盲人。欲了解更多关于原型的信息，请访问 [`https://www.youtube.com/watch?v=Xe5RcJ1JY3c`](https://www.youtube.com/watch?v=Xe5RcJ1JY3c) 。
