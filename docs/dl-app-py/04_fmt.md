...
图 4-2 Linear model with multiple inputs
...
图 4-5 Chart of logistic regression model
...
图 4-6 Plot for cross entropy loss per epoch
...
图 4-8 Plot for loss while training and testing
