...
在数学优化问题中，Rastrigin 函数是一个非凸函数，用作优化算法的性能测试问题。其公式如图 4-21 所示，图 4-22 展示了其典型输出。![A454310_1_En_4_Fig21_HTML.jpg](img/A454310_1_En_4_Fig21_HTML.jpg) 图 4-21. Rastrigin 函数示意图 ![A454310_1_En_4_Fig22_HTML.jpg](img/A454310_1_En_4_Fig22_HTML.jpg) 图 4-22. Rastrigin 函数输出
...
当我们开始构建重要的库时，如果这些库尚未创建，Python 会缓存它们，如图 4-23 所示。![A454310_1_En_4_Fig23_HTML.jpg](img/A454310_1_En_4_Fig23_HTML.jpg) 图 4-23. 正在创建缓存
...
如果你回到文件夹，可以看到`rastrigin.png`文件已经创建，如图 4-24 所示。![A454310_1_En_4_Fig24_HTML.jpg](img/A454310_1_En_4_Fig24_HTML.jpg) 图 4-24. 正在保存 Rastrigin 函数 PNG 文件

该问题输出的`rastrigin.png`文件显示了极小值点，如图 4-25 所示。要找到全局最优解非常困难。![A454310_1_En_4_Fig25_HTML.jpg](img/A454310_1_En_4_Fig25_HTML.jpg) 图 4-25. Rastrigin 函数 PNG 文件
