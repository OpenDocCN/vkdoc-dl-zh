...
![混淆矩阵](img/479940_1_En_4_Fige_HTML.jpg)

```python
accuracy_score(pred,y_test)
```

![准确率](img/479940_1_En_4_Figf_HTML.jpg)

```python
recall_score(pred,y_test)
```

![召回率](img/479940_1_En_4_Figg_HTML.jpg)

```python
precision_score(pred,y_test)
```

![精确率](img/479940_1_En_4_Figh_HTML.jpg)

```python
f1_score(pred,y_test)
```

![F1分数](img/479940_1_En_4_Figi_HTML.jpg)
...
![均方根误差公式](img/479940_1_En_4_Chapter_TeX_Equf.png)
...
![R平方公式](img/479940_1_En_4_Chapter_TeX_Equg.png)

数学上，`R²` 可以表示如下：

![R平方数学公式](img/479940_1_En_4_Chapter_TeX_Equh.png)
...
![调整后的R平方公式](img/479940_1_En_4_Chapter_TeX_Equi.png)

### 赤池信息准则

如果你知道模型的均方根误差，对其求平方即可得到均方误差。利用它，你可以找到模型的 AIC，如下所示：

![AIC公式](img/479940_1_En_4_Chapter_TeX_Equj.png)
...
![BIC公式](img/479940_1_En_4_Chapter_TeX_Equk.png)
...
![summary输出](img/479940_1_En_4_Fig11_HTML.jpg)
...
![过拟合与欠拟合](img/479940_1_En_4_Fig12_HTML.jpg)
...
![偏差与方差](img/479940_1_En_4_Fig13_HTML.jpg)
