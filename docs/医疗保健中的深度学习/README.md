...
Lakhmi C. Jain，悉尼科技大学工程与信息技术学院，人工智能中心，悉尼，新南威尔士州，澳大利亚；堪培拉大学科学、技术和数学学院，堪培拉，澳大利亚；KES国际，Shoreham-by-Sea，英国；利物浦希望大学，利物浦，英国

该系列的目标是以易于访问和良好结构的形式出版一个参考图书馆，包括智能系统各个方面的新进展和发展。该系列包括参考工具书、手册、汇编、教科书、结构良好的专著、词典和百科全书。它包含了智能系统领域的集成知识和当前信息。该系列涵盖了智能系统的理论、应用和设计方法。几乎所有学科，如工程学、计算机科学、航空学、商业、电子商务、环境、医疗保健、物理学和生命科学都包括在内。主题列表涵盖了现代智能系统的所有领域，如：环境智能、计算智能、社会智能、计算神经科学、人工生命、虚拟社会、认知系统、DNA和免疫系统、电子学习和教学、以人为中心的计算和机器伦理、智能控制、智能数据分析、基于知识的范式、知识管理、智能代理、智能决策、智能网络安全、交互娱乐、学习范式、推荐系统、机器人学和机电一体化，包括人机协作、自组织和自适应系统、软计算，包括神经系统、模糊系统、进化计算和这些范式的融合、感知和视觉、网络智能和多媒体。

- **索引：** 本系列图书已提交至ISI Web of Science、SCOPUS、DBLP和Springerlink。

有关本系列的更多信息，请访问http://www.springer.com/series/8578
...
编辑
陈彦伟 信息科学与工程学院 立命馆大学 日本草津
浙江实验室 中国杭州

Lakhmi C. Jain
工程与信息技术学院 人工智能中心 悉尼科技大学 澳大利亚新南威尔士州
科学、技术和数学学院 堪培拉大学 澳大利亚堪培拉
KES国际 英国肖勒姆海滩
利物浦希望大学 英国利物浦

ISSN 1868-4394 ISSN 1868-4408（电子版）
智能系统参考图书馆
ISBN 978-3-030-32605-0 ISBN 978-3-030-32606-7（电子书）
...
出版商、作者和编辑可以安全地假设本书中的建议和信息在出版日期时是真实准确的。出版商、作者或编辑对本书中所含材料或可能存在的任何错误或遗漏不提供明示或暗示的保证。出版商在已发表的地图和机构隶属关系方面保持中立。

这本斯普林格印记由注册公司斯普林格自然瑞士股份有限公司出版
注册公司地址为：瑞士Cham市Gewerbestrasse 11号6330
...
## 第一部分：深度学习在医疗保健中的基础知识

### 1 医学图像检测与深度学习

María Inmaculada García Ocaña, Karen López-Linares Román, Nerea Lete Urzelai, Miguel Ángel González Ballester 和 Iván Macía Oliver
...
Karen López-Linares Román, María Inmaculada García Ocaña, Nerea Lete Urzelai, Miguel Ángel González Ballester 和 Iván Macía Oliver

#### 2.1 引言

#### 2.2 在应用深度学习时的挑战和限制对医学图像分割

#### 2.3 用于医学图像分割的深度学习架构分割
##### 2.3.1 监督式深度学习架构
##### 2.3.2 半监督式深度学习架构
##### 2.3.3 从2D到3D分割网络
...
王伟斌，梁东，陈晴晴，岩本裕太郎，韩先华，张巧薇，胡洪杰，林兰芬和陈彦伟

#### 3.1 引言
##### 3.1.1 什么是图像分类
##### 3.1.2 图像分类中取得的成就 使用深度学习
...
#### 3.4 应用于肝脏病灶的分类
##### 3.4.1 肝脏病灶和多相CT图像
##### 3.4.2 多通道CNN用于肝脏病灶的分类 多相CT图像上的病变
##### 3.4.3 实验结果
...
#### 4.3.4 基于密集跳跃连接的卷积神经网络 用于超分辨率的网络（SRDenseNet）
##### 4.3.5 用于图像超分辨率的残差密集网络（RDN）
#### 4.3.6 2D图像超分辨率的实验结果 超分辨率

#### 4.4 3D超分辨率的医学图像增强
##### 4.4.1 用于超分辨率的3D卷积神经网络（3D-SRCNN）
##### 4.4.2 3D深度连接超分辨率网络（3D-DCSRN）
##### 4.4.3 使用生成对抗网络和3D多级密集连接网络的超分辨率网络（mDCSRN-GAN）
##### 4.4.4 3D图像的实验结果 超分辨率
...
### 5 提高医学图像中深度卷积神经网络的性能 有限资源下的分割

Saeed Mohagheghi, Amir Hossein Foruzan 和 Yen-Wei Chen
...
王文哲，冯瑞伟，刘雪晨，陆一飞，王艳杰，郭若倩，林志文，陈婷婷，陈志宏和吴健
...
#### 7.3 用于肺HRCT的两阶段特征迁移的应用 分析
##### 7.3.1 材料
##### 7.3.2 实验细节
##### 7.3.3 实验结果

#### 7.4 迁移学习是如何工作的？
##### 7.4.1 通过可视化特征进行定性分析 表示
##### 7.4.2 数值分析：特征的频率响应 提取部分

#### 7.5 结论

参考文献

### 8 基于解剖标志的深度学习用于结构磁共振成像的阿尔茨海默病诊断

Mingxia Liu, Chunfeng Lian 和 Dinggang Shen

#### 8.1 引言

#### 8.2 材料和图像预处理

#### 8.3 用于脑部sMRI的解剖标志点发现
##### 8.3.1 体素对应的生成
##### 8.3.2 不同组之间的体素比较
##### 8.3.3 AD相关解剖标志点的定义
##### 8.3.4 未知测试对象的标志点检测

#### 8.4 基于标志点的深度网络用于疾病诊断
##### 8.4.1 基于标志点的补丁提取
##### 8.4.2 多实例卷积神经网络
...
### 10 CT图像中弥漫性肺疾病的浓度标记使用无监督和半监督学习

Shingo Mabu, Shoji Kido, Yasuhi Hirano 和 Takashi Kuremoto
...
## 11 用于无监督特征学习的残差稀疏自编码器及其在HEp-2细胞染色模式中的应用
- 识别
- 韩贤华和陈彦伟
- 11.1 引言
- 11.2 相关工作
- 11.3 自编码器及其扩展：稀疏自编码器
- 11.4 用于自学习的残差SAE
- 11.5 残差SAE的聚合激活
    - 用于图像表示
- 11.6 实验
...
## 12 Dr. Pecker：基于深度学习的计算机辅助诊断医学成像系统
- 程国华和何林阳
- 12.1 引言
- 12.2 系统概述
    - 12.2.1 与医院IT的无缝集成
