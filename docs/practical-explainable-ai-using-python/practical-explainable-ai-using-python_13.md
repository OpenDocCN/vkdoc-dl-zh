...
| ![../images/506619_1_En_6_Chapter/506619_1_En_6_Figa_HTML.jpg](img/506619_1_En_6_Figa_HTML.jpg) |
...
系数`1.2182`和`0.2156`的`p`值为`0.000`，小于`0.05`，这意味着 95%的置信水平和 5%的统计显著性水平。对于一阶和二阶滞后项，这足够显著，能够影响实际时间序列`Yt`。这可以解释为：*如果滞后项变化一个单位，序列的实际值预计变化 0.22%*。滞后 2 的系数可以解释为：*如果滞后 2 变化一个单位，序列`Yt`将减少 0.2156 倍*。参见`Table 6-2`。

**Table 6-2**  
包含两个滞后项的自回归模型结果

| ![../images/506619_1_En_6_Chapter/506619_1_En_6_Figb_HTML.jpg](img/506619_1_En_6_Figb_HTML.jpg) |
