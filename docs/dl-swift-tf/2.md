...
第一种方法，如图 2-8 所示，雅可比矩阵很简单。这里我们简单计算一下 **Y** 相对于向量 **x** 的每个标量输入变量的偏导数。这些偏导数分别是∂**y**/∂*x*T10】1 和∂**y**/∂*x*t16】2。现在我们把所有这些偏导数整理成一个形状为(3 × 4) × 2 的雅可比张量。
