...
![单层/单神经元模型](img/495303_1_En_3_Fig1_HTML.jpg)
图 3-1 单层/单神经元模型
...
![多层模型](img/495303_1_En_3_Fig2_HTML.jpg)
图 3-2 多层模型
...
![多层网络的网络图](img/495303_1_En_3_Fig3_HTML.jpg)
图 3-3 多层网络的网络图
...
| ![几种复杂的 ANN 架构](img/495303_1_En_3_Figa_HTML.gif) |
...
![包含自定义层的网络](img/495303_1_En_3_Fig4_HTML.jpg)
图 3-4 包含自定义层的网络
...
![图 3-5 彩色图像 275x183 像素](img/495303_1_En_3_Fig5_HTML.jpg)

`图 3-5` 彩色图像 275x183 像素

如果我问你这张图像显示的是什么？你会立刻回答：这是一只鸟。这张图像的大小为 275x183 像素，每个像素代表一个包含 `RGB` 分量的颜色值。现在，我将把同一张图像转换为黑白素描图。新图像如图 3-6 所示。

![图 3-6 黑白素描图像 275x183 像素](img/495303_1_En_3_Fig6_HTML.jpg)

`图 3-6` 黑白素描图像 275x183 像素

同样，如果我问你这张图像显示的是什么？你会说这是一只鸟。现在，我将把图像缩小到 32x32 像素。缩小后的新图像如图 3-7 所示。

![图 3-7 缩小后的图像 32x32 像素](img/495303_1_En_3_Fig7_HTML.jpg)

`图 3-7` 缩小后的图像 32x32 像素
...
![图 3-8 汽车图像及其变换](img/495303_1_En_3_Fig8_HTML.jpg)
...
![图 3-9 `CNN` 架构](img/495303_1_En_3_Fig9_HTML.jpg)
...
![图 3-10：`CIFAR-10` 示例图像](img/495303_1_En_3_Fig10_HTML.jpg)
...
![图 3-11：数据集中的示例图像](img/495303_1_En_3_Fig11_HTML.jpg)
...
![模型 4 网络图](img/495303_1_En_3_Fig23_HTML.jpg)
`图 3-23 模型 4 网络图`

模型的误差指标如图 3-24 所示。

![模型 4 误差指标](img/495303_1_En_3_Fig24_HTML.jpg)
`图 3-24 模型 4 误差指标`
...
![模型 5 网络图](img/495303_1_En_3_Fig25_HTML.jpg)
`图 3-25 模型 5 网络图`

![图 3-25 模型 5 网络结构图](img/495303_1_En_3_Fig25_HTML.jpg)

误差指标图如图 3-26 所示。

![图 3-26 模型 5 误差指标](img/495303_1_En_3_Fig26_HTML.jpg)
...
![图 3-27 用于测试的未见过的图像](img/495303_1_En_3_Fig27_HTML.jpg)
