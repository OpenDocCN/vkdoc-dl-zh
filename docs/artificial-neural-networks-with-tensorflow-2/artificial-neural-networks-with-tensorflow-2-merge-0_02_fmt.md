...
![深度学习框架增长情况 – 2019 年](img/495303_1_En_1_Fig1_HTML.jpg)
图 1-1 深度学习框架增长情况 – 2019 年

2018 年对几个流行框架进行的类似调查如图 1-2 所示。

![几个深度学习框架的功率分数](img/495303_1_En_1_Fig2_HTML.jpg)
图 1-2 几个深度学习框架的功率分数
...
![TensorFlow 2.x 平台](img/495303_1_En_1_Fig3_HTML.jpg)
...
![训练模块](img/495303_1_En_1_Fig4_HTML.jpg)
图 1-4 训练模块
...
![数据设计模块](img/495303_1_En_1_Fig5_HTML.jpg)
图 1-5 数据设计模块
...
![`tf.estimator` 模块](img/495303_1_En_1_Fig6_HTML.jpg)
...
![分布式策略模块](img/495303_1_En_1_Fig7_HTML.jpg)
图 1-7 分布式策略模块
...
![TensorBoard 模块](img/495303_1_En_1_Fig8_HTML.jpg)
...
![模型保存模块](img/495303_1_En_1_Fig9_HTML.jpg)
图 1-9 模型保存模块
...
![模型部署选项](img/495303_1_En_1_Fig10_HTML.jpg)
图 1-10 模型部署选项
...
![计算图](img/495303_1_En_1_Fig11_HTML.jpg)
图 1-11 计算图
...
![TensorBoard 指标显示](img/495303_1_En_1_Fig12_HTML.jpg)
...
由于本书中的项目将使用 `Google Colab`，我将向你展示如何在 `Colab` 中测试 `TensorFlow` 的安装。通过打开网址 <http://colab.research.google.com> 来启动 `Colab`。假设你已登录 `Google` 账户，你将看到如图 1-13 所示的截图。

![../images/495303_1_En_1_Chapter/495303_1_En_1_Fig13_HTML.jpg](img/495303_1_En_1_Fig13_HTML.jpg)

图 1-13 `Colab` 打开一个新笔记本
