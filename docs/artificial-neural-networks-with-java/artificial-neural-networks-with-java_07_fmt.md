...
- 链式法则：该法则告诉我们如何对复合函数求导。它指出 ![$$ \frac{\kern0.5em \partial y}{\partial x}=\frac{\kern0.5em \partial y}{\partial u}\ast \frac{\kern0.5em \partial u}{\partial x} $$](img/477043_2_En_2_Chapter_TeX_IEq18.png)，其中 `u = f(x)`。示例如下：`y = u⁸` 且 `u = x² + 5`。根据链式法则，![$$ \frac{\kern0.5em \partial y}{\partial x}=\frac{\kern0.5em \partial y}{\partial u}\ast \frac{\kern0.5em \partial u}{\partial x} $$](img/477043_2_En_2_Chapter_TeX_IEq19.png) = `8u⁷ * 2x` = `16x * (x² + 5)⁷`
