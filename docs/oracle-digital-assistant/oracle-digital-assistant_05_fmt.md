...
对话式用户体验帮助企业更有效地销售其产品/服务或帮助客户。这也是通过消息和聊天应用（如 `Facebook Messenger`、`WhatsApp`、`Talk` 和 `微信`）或通过语音技术（如亚马逊的 `Echo` 产品，它通过语音命令与公司交互）与企业进行交互这一趋势的原因。通过对话式商务，客户可以在消息应用内与公司代表聊天、提问、获得客户支持、获得个性化推荐、阅读评论并一键购买。随着越来越多的人成为重度移动用户，提供更无缝的移动在线购物体验是一个很好的商业理念。通过对话式商务，消费者可以与人类代表、聊天机器人或两者结合进行互动。
...
![图 2-1 用户只需点击一下即可继续对话](img/479330_1_En_2_Fig1_HTML.jpg)
...
![图 2-2 挑战在于找到良好的平衡](img/479330_1_En_2_Fig2_HTML.jpg)

我们将流程分为八个步骤。图 2-3 展示了这些步骤。随后各节将依次描述每个步骤。

![图 2-3 八个设计步骤](img/479330_1_En_2_Fig3_HTML.jpg)
...
![图 2-4](img/479330_1_En_2_Fig4_HTML.png)
...
![图 2-5 通过访谈和观察目标群体进行用户研究](img/479330_1_En_2_Fig5_HTML.jpg)
...
![图 2-6 代表呼叫中心员工的人物角色示例](img/479330_1_En_2_Fig6_HTML.jpg)
...
![图 2-7 墙上真人大小的用户画像将时刻印在团队脑海中](img/479330_1_En_2_Fig7_HTML.jpg)

用户画像使团队能够基于对用户的了解来设计聊天机器人。他们开发什么、如何运作、想要达成什么目标，以及同样重要的语气语调，都可以基于你对用户的了解。

## 用户旅程地图

![图 2-8](img/479330_1_En_2_Fig8_HTML.png)
...
![图 2-9 展示不同路径的旅程地图示例](img/479330_1_En_2_Fig9_HTML.jpg)
...
![图 2-10 详细的客户/用户旅程地图](img/479330_1_En_2_Fig10_HTML.jpg)
...
![图 2-11 用户在场景创建中扮演主角。](img/479330_1_En_2_Fig11_HTML.jpg)
...
![图 2-12](img/479330_1_En_2_Fig12_HTML.png)
...
![一个让用户感到一切尽在掌握的对话示例](img/479330_1_En_2_Fig15_HTML.jpg)
...
![后端系统示意图](img/479330_1_En_2_Fig16_HTML.png)
**`图 2-16`**
...
让我们以 `图 2-17` 中的数字助手为例。

![用户想要预订选定的酒店](img/479330_1_En_2_Fig17_HTML.jpg)
**`图 2-17`** 用户想要预订选定的酒店
...
![示例实体示意图](img/479330_1_En_2_Fig18_HTML.png)
**`图 2-18`**
...
与项目利益相关者共享实体可能会有所帮助。使用 `图 2-19` 中所示的词云方法，是一种快速提供所支持实体概览的方式，同时也能显示它们的相对重要性或至少是相对使用频率。

![词云是一种向利益相关者展示所有不同实体的方式](img/479330_1_En_2_Fig19_HTML.jpg)
**`图 2-19`** 词云是一种向利益相关者展示所有不同实体的方式

## 可用性测试

![可用性测试示意图](img/479330_1_En_2_Fig20_HTML.png)
**`图 2-20`**
