...
![图 10-1](img/525591_1_En_10_Fig1_HTML.png)
...
![图 10-2](img/525591_1_En_10_Fig2_HTML.png)
...
![图 10-3](img/525591_1_En_10_Fig3_HTML.png)
...
![图 10-4](img/525591_1_En_10_Fig4_HTML.png)
...
![图 10-5](img/525591_1_En_10_Fig5_HTML.png)
...
预期改进测量量化了与要优化的参数集 *x* 相关的预期改进。例如，如果代理模型 *p*(*y*| *x*) 对所有小于某个阈值值 *y*^∗ 的 *y* 值都评估为零——也就是说，输入参数 *x* 的集合产生目标函数输出小于 *y*^∗ 的概率为零——那么通过采样 *x* 可能找到任何改进。
...
**列表 10-15**：一个更好的、用于模型超参数优化的嵌套搜索空间。
...
**列表 10-16**：一个简洁的目标函数，它基于列表 10-15 中设计良好的嵌套搜索空间。
...
**列表 10-17**：在目标函数中添加额外的处理，以应对比其他地方更容易处理的潜在无效采样。
...
![图 10-18](img/525591_1_En_10_Fig18.jpg)
