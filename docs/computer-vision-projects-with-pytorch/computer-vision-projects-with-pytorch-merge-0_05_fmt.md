...
![图 4-1a 原始输入图像](img/520381_1_En_4_Fig1_HTML.jpg)
...
![图 4-1b 从输入中提取像素块](img/520381_1_En_4_Fig2_HTML.jpg)
...
![图 4-2 实例分割流程](img/520381_1_En_4_Fig3_HTML.png)
...
![图 4-3 自定义数据上的输出](img/520381_1_En_4_Fig4_HTML.jpg)
...
class CustomDataset(Dataset):
    def __init__(self, dir_path, transforms=None):
        ...
        # 从 dir_path 添加来自 PedMasks 目录的掩码列表
...
- 我们为类定义了三个重要函数——`__init__`、`__getitem__` 和 `__len__`。
