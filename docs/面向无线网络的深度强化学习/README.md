...
系列编辑
Woon-Seng Gan, 新加坡南洋理工大学电气与电子工程学院, 新加坡
C.-C. Jay Kuo, 南加州大学, 美国洛杉矶
Thomas Fang Zheng, 清华大学信息技术研究院, 中国北京
Mauro Barni, 西亚纳大学信息工程与数学系, 意大利锡耶纳

斯普林格简报提供了在各个领域的前沿研究和实际应用的简明摘要。该系列包括50到125页的紧凑卷，涵盖了从专业到学术的各种内容。

典型主题可能包括：及时报告最先进的分析技术，作为期刊文章中发布的新研究结果和上下文文献综述之间的桥梁，热门或新兴主题的快照，深入案例研究或临床示例以及学生必须理解的核心概念，以便做出独立贡献。

有关该系列的更多信息，请访问http://www.springer.com/series/10059

F. Richard Yu • Ying He

# 深度强化学习在无线网络中的应用

![](img/bf3779e935ce546905386e0e0d629e4b_3_0.png)
...
ISSN 2191-8112			ISSN 2191-8120（电子版）
电气与计算机工程SpringerBriefs
ISBN 978-3-030-10545-7		ISBN 978-3-030-10546-4（电子书）
https://doi.org/10.1007/978-3-030-10546-4
美国国会图书馆控制号：2018967964

© 作者（们），独家许可给Springer Nature Switzerland AG 2019
本作品受版权保护。出版商保留所有权利，无论是全部还是部分材料，特别是翻译、重印、插图的再利用、朗诵、广播、微缩胶片复制、或以任何其他实体方式的复制，以及信息的传输或存储和检索、电子适应、计算机软件，或通过类似或不同的方法现在已知或今后开发的方法。

在本出版物中使用一般描述性名称、注册名称、商标、服务标志等，并不意味着即使在没有明确声明的情况下，这些名称也不受相关保护法律和法规的约束，因此可以自由使用。

出版商、作者和编辑可以安全地假设本书中的建议和信息在出版日期时被认为是真实和准确的。出版商、作者或编辑对本文中包含的材料不提供任何明示或暗示的保证，也不对可能存在的错误或遗漏承担责任。出版商在已发表的地图和机构隶属方面保持中立。

这个Springer印记由注册公司Springer Nature Switzerland AG出版。注册公司地址为：Gewerbestrasse 11, 6330 Cham, Switzerland
