...
![图 3-11](img/527966_1_En_3_Fig11_HTML.jpg)
...
![图 3-12 – XenonStack 大数据摄取架构](img/527966_1_En_3_Fig12_HTML.jpg)
...
![图 3-13 – Red Hat 数据管道摄取](img/527966_1_En_3_Fig13_HTML.jpg)
...
![图 3-15 – AWS 数据摄取](img/527966_1_En_3_Fig15_HTML.jpg)

一个用于数据摄取的 AWS 架构。该流程包含 5 个阶段：1. 摄取；2. 存储与处理；3. 编目、治理与搜索；4. 消费；5. 安全与监控。

**图 3-15** – AWS 数据摄取

![图 3-14 – 用于数据摄取的 AWS 无服务器（Lambda）架构](img/527966_1_En_3_Fig14_HTML.jpg)
...
![图 3-16 – Databricks 与 Apache Spark](img/527966_1_En_3_Fig16_HTML.jpg)
...
![图 3-17 Snowflake 工作负载管理](img/527966_1_En_3_Fig17_HTML.jpg)
