...
![$$ \beta ={\left({X}^{\prime }X\right)}^{-1}{X}^{\prime }Y $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equa.png)
...
![../images/496662_1_En_1_Chapter/496662_1_En_1_Fig1_HTML.jpg](../images/496662_1_En_1_Chapter/496662_1_En_1_Fig1_HTML.jpg)
...
![../images/496662_1_En_1_Chapter/496662_1_En_1_Fig2_HTML.png](../images/496662_1_En_1_Chapter/496662_1_En_1_Fig2_HTML.png)
...
在某些情况下，训练模型所需的数据将是分散的，这使得用标准方法完成任务变得不可行。对于学术界和公共部门的经济学家来说，当法律或隐私问题阻止数据共享时，这个问题经常出现。对于行业经济学家来说，当数据分布在移动电话等用户设备上，但无法集中时，可能会出现这种情况。在前面的所有案例中，联合学习提供了在不集中数据的情况下训练模型的可能性。这可以使用 TensorFlow 联邦扩展来完成。
...
实际上，我们经常用张量的秩和形状来描述张量。索引为*k*![$$ {Y}_{i_{1,\dots, }{i}_k} $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_IEq1.png)的矩形阵列被称为秩为- *k* 。你也可以看到这样一个数组，它被描述为具有顺序或维度 *k* 。张量的形状是由它的每个维度的长度决定的。
...
![../images/496662_1_En_1_Chapter/496662_1_En_1_Fig3_HTML.png](../images/496662_1_En_1_Chapter/496662_1_En_1_Fig3_HTML.png)
...
![$$ \left[\begin{array}{c}{a}_0\\ {}{a}_1\\ {}{a}_2\end{array}\right]+\left[\begin{array}{c}{b}_0\\ {}{b}_1\\ {}{b}_2\end{array}\right]=\left[\begin{array}{c}{a}_0+{b}_0\\ {}{a}_1+{b}_1\\ {}{a}_2+{b}_2\end{array}\right] $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equb.png)
...
![$$ c=\sum \limits_{i=0}^n{a}_i{b}_i $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equf.png)
...
![$$ {C}_{i_1\dots {i}_k}=\gamma +{A}_{i_1\dots {i}_k} $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equi.png)

*方程式 1-10。* *标量-张量相乘* *。*

![$$ {C}_{i_1\dots {i}_k}=\gamma {A}_{i_1\dots {i}_k} $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equj.png)
...
![$$ Y=\alpha + X\beta $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equk.png)
...
![$$ {Y}_2-{Y}_1=\left(\alpha +{X}_2\beta \right)-\left(\alpha +{X}_1\beta \right) $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equl.png)

![$$ =\Delta Y=\Delta X\beta $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equm.png)

将等式两边除以δ*X*得到相对于 *X* 变化的 *Y* 变化的表达式。这只是导数 *X* ，如等式 1-13 所示。

*方程式 1-13。Y 相对于 x 的导数*

![$$ \frac{\Delta Y}{\Delta X}=\upbeta $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equn.png)
...
![../images/496662_1_En_1_Chapter/496662_1_En_1_Fig4_HTML.png](../images/496662_1_En_1_Chapter/496662_1_En_1_Fig4_HTML.png)
...
![../images/496662_1_En_1_Chapter/496662_1_En_1_Fig5_HTML.png](../images/496662_1_En_1_Chapter/496662_1_En_1_Fig5_HTML.png)
...
![$$ {f}^{\prime }(X)=\underset{\mathrm{h}\to 0}{\lim}\frac{f\left(X+h\right)-f(X)}{\left(X+h\right)-X}=\underset{h\to 0}{\lim}\frac{f\left(X+h\right)-f(X)}{h} $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equo.png)
...
![$$ {f}^{\prime }(X)=\underset{\mathrm{h}\to 0}{\lim}\frac{{\left(X+h\right)}^2-{X}^2}{h} $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equp.png)

![$$ =\underset{\mathrm{h}\to 0}{\lim }2X+h $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equq.png)

![$$ =2X $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equqq.png)
...
![$$ {f}^{\prime }(X)=\underset{\mathrm{h}\to 0}{\lim}\frac{\left[{\left(X+h\right)}^2-\left(X+h\right)\right]-\left({X}^2-X\right)\ }{h} $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equr.png)

![$$ =\underset{h\to 0}{\lim }2X+h-1 $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equs.png)

![$$ =2X-1 $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equt.png)
...
![$$ 0=2\mathrm{X}-1 $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equu.png)

![$$ \to \mathrm{X}=0.5 $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equuu.png)
...
![$$ {f}^{\prime \prime }(X)=\underset{\mathrm{h}\to 0}{\lim}\frac{\left[2\left(X+h\right)-1\right]-\left[2X-1\right]\ }{h}=2 $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equv.png)
...
![$$ {f}^{\prime}\left({X}^{\ast}\right)=0 $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equw.png)

![$$ {f}^{\prime \prime}\left({X}^{\ast}\right)&gt;0 $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equx.png)

类似地，如果等式 1-20 中的陈述为真，则满足局部最大值的条件。

*方程式 1-20。局部极大值的充要条件。*

![$$ {f}^{\prime}\left({X}^{\ast}\right)=0 $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equy.png)

![$$ {f}^{\prime \prime}\left({X}^{\ast}\right)&lt;0 $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equz.png)
...
![$$ f(X)={X}^2\to {f}^{\prime }(X)=2X $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equaa.png)

![$$ f(X)=2X\to {f}^{\prime }(X)=2 $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equab.png)

![$$ f(X)={X}^2-X\to {f}^{\prime }(X)=2X-1 $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equac.png)

![$$ f(X)=2X-1\to {f}^{\prime }(X)=2 $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equad.png)
...
| 常数法则 | ![$$ \frac{d}{dx}\ \mathrm{c}=0 $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_IEq2.png) |
| 乘法法则 | ![$$ \frac{d}{dx}\ cX=c $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_IEq3.png) |
| 权力规则 | ![$$ \frac{d}{dx}\ {\mathrm{X}}^{\mathrm{n}}=n{X}^{n-1} $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_IEq4.png) |
| 求和规则 | ![$$ \frac{d}{dx}\ f(X)+g(X)={f}^{\prime }(X)+{g}^{\prime }(X) $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_IEq5.png) |
| 乘积规则 | ![$$ \frac{d}{dx}f(X)g(X)={f}^{\prime }(X)g(X)+f(X){g}^{\prime }(X) $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_IEq6.png) |
| 链式法则 | ![$$ \frac{d}{dx}f\left(g(X)\right)={f}^{\prime}\left(g(X)\right){g}^{\prime }(X) $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_IEq7.png) |
| 互惠法则 | ![$$ \frac{d}{dx}\frac{1}{f(X)}=-\frac{f^{\prime }(X)}{{\left(f(X)\right)}^2} $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_IEq8.png) |
| 商数法则 | ![$$ \frac{d}{dx}\frac{f(X)}{g(X)}=\frac{f^{\prime }(X)g(X)-{g}^{\prime }(X)f(X)}{g{(X)}^2} $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_IEq9.png) |
...
<colgroup><col class="tcol1 align-left"> <col class="tcol2 align-left"></colgroup> 
| 指数法则 | ![$$ \frac{d}{dx}\ {\mathrm{e}}^{cx}=c{e}^{cx} $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_IEq10.png) |
| 自然对数规则 | ![$$ \frac{d}{dx}\ \ln \left(\mathrm{X}\right)=\frac{1}{X} $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_IEq11.png) |
| 正弦规则 | ![$$ \frac{d}{dx}\sin \left(\mathrm{X}\right)=\cos (X) $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_IEq12.png) |
| 余弦规则 | ![$$ \frac{d}{dx}\cos \left(\mathrm{X}\right)=-\mathit{\sin}(X) $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_IEq13.png) |
...
![$$ \nabla L\left({X}_1,\dots, {X}_n\right)=\left[\frac{\partial L}{\partial {X}_1}\right.,\dots, \left.\frac{\partial L}{\partial {X}_n}\right] $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equae.png)
...
![$$ \mathrm{J}=\left(\begin{array}{ccc}\frac{\partial {f}_1}{\partial {X}_1}&amp; \cdots &amp; \frac{\partial {f}_1}{\partial {X}_n}\\ {}\vdots &amp; \ddots &amp; \vdots \\ {}\frac{\partial {f}_m}{\partial {X}_1}&amp; \cdots &amp; \frac{\partial {f}_m}{\partial {X}_1}\end{array}\right) $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equaf.png)

为了使这一点具体化，让我们计算两个函数和两个变量的雅可比，它们在等式 1-24 中给出。

*方程式 1-24。一个* *两个函数两个变量的系统。*

![$$ {f}_1\left({X}_1,{X}_2\right)=2{X}_1{X}_2 $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equag.png)

![$$ {f}_2\left({X}_1,{X}_2\right)={X}_1^2-{X}_2^2 $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equah.png)
...
![$$ \mathrm{J}=\left(\begin{array}{cc}2{X}_2&amp; 2{X}_1\\ {}2{X}_1&amp; -2{X}_2\end{array}\right) $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equai.png)
...
![$$ Hf=\left(\begin{array}{ccc}\frac{\partial f}{\partial {X}_1^2}&amp; \cdots &amp; \frac{\partial f}{\partial {X}_1{X}_n}\\ {}\vdots &amp; \ddots &amp; \vdots \\ {}\frac{\partial f}{\partial {X}_n{X}_1}&amp; \cdots &amp; \frac{\partial f}{\partial {X}_n^2}\end{array}\right) $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equaj.png)

关于黑森有两件事值得注意。首先，它是在标量值函数上计算的，类似于梯度。第二，它由二阶偏导数组成。在使用的符号中，![$$ \partial f/\partial {X}_i^2 $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_IEq14.png)是对 *X* <sub>* i *</sub> 的二阶偏导数，而不是对![$$ {X}_i^2 $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_IEq15.png)的偏导数。

最后，让我们考虑一个二元函数的 Hessian。这个函数在方程 1-27 中给出，然后在方程 1-28 中给出它的 Hessian 值。

*方程式 1-27。海森矩阵计算的示例函数。*

![$$ f\left({X}_1,{X}_2\right)={X}_1^2{X}_2-2{X}_2^2 $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equak.png)

*方程式 1-28。二元函数的 Hessian 矩阵。*

![$$ Hf=\left(\begin{array}{cc}2{X}_2&amp; 2{X}_1\\ {}2{X}_1&amp; -4\end{array}\right) $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equal.png)
...
![$$ \frac{d}{dx}f\left(g(x)\right)={f}^{\prime}\left(g(x)\right){g}^{\prime }(x)=30{x}^5 $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equam.png)
...
![$$ {f}^{\prime }(x)\approx \frac{f\left(x+h\right)-f(x)}{h} $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equan.png)
...
![$$ \frac{d}{dx}f\left(g(x)\right)\approx \frac{5{\left(x+h\right)}^6-5{x}^6}{h} $$](../images/496662_1_En_1_Chapter/496662_1_En_1_Chapter_TeX_Equao.png)
...
由于 TensorFlow 2 默认使用急切执行，因此不再需要在静态计算图的限制内工作。这意味着您现在可以直接使用`numpy`数组，而无需先将它们转换成`tf.constant()`对象。这也意味着我们可以在`numpy`和`pandas`使用标准的数据导入和预处理管道。

清单 [1-21](#PC25) 为神经网络的 4 阶图像张量输入提供了加载和预处理管道。我们将假设张量已经以`npy`格式存储，它可以用来保存任意的`numpy`数组。
