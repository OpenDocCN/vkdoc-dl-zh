...
图 5-32：LUIS 对话服务 – 应用程序设置和应用程序 ID
...
图 5-33：在 Visual Studio 项目中替换密钥
...
图 5-37：Speech Studio – 自定义关键词训练模型
