...
![img/463356_1_En_1_Chapter/463356_1_En_1_Fig1_HTML.jpg](img/463356_1_En_1_Fig1_HTML.jpg)
图 1-1 在 Anaconda 网站上，您可以在页面右上角找到一个下载所需软件的链接

简单地按照说明进行安装。安装完成后启动它，您将看到图 1-2 中所示的屏幕。如果您没有看到这个屏幕，只需在左侧导航面板上点击“主页”链接。

![img/463356_1_En_1_Chapter/463356_1_En_1_Fig2_HTML.jpg](img/463356_1_En_1_Fig2_HTML.jpg)
图 1-2 启动 Anaconda 时您看到的屏幕
...
![img/463356_1_En_1_Chapter/463356_1_En_1_Fig3_HTML.jpg](img/463356_1_En_1_Fig3_HTML.jpg)
图 1-3 要创建一个新环境，您首先必须通过点击左侧导航面板中的相关链接（图中的黑色矩形所示）进入应用程序的环境部分。

然后点击中间导航面板中的创建按钮（如图 1-4 所示）。

![img/463356_1_En_1_Chapter/463356_1_En_1_Fig4_HTML.jpg](img/463356_1_En_1_Fig4_HTML.jpg)
图 1-4 要创建一个新的环境，您必须从中间导航面板中点击创建按钮（在图中用红色箭头指示按钮的位置）。

当您点击创建按钮时，会弹出一个小的窗口（见图 1-5）。

![img/463356_1_En_1_Chapter/463356_1_En_1_Fig5_HTML.jpg](img/463356_1_En_1_Fig5_HTML.jpg)
图 1-5 当您点击图 1-4 中指示的创建按钮时，您将看到的窗口
...
![img/463356_1_En_1_Chapter/463356_1_En_1_Fig6_HTML.jpg](img/463356_1_En_1_Fig6_HTML.jpg)
图 1-6 从下拉菜单中选择“未安装”值

接下来，在“搜索包”字段中输入您想要安装的包名（图 1-7 显示已选择了 `numpy`）。

![img/463356_1_En_1_Chapter/463356_1_En_1_Fig7_HTML.jpg](img/463356_1_En_1_Fig7_HTML.jpg)
图 1-7 在搜索字段中输入“numpy”，以便将其包含在包存储库中

Anaconda 导航器将自动显示所有标题或描述中包含单词 `numpy` 的包。点击名称为 `numpy` 的包名称左侧的小方块。它将变成一个小向下箭头（表示已标记为安装）。然后您可以在界面的右下角点击绿色的“应用”按钮（见图 1-8）。

![img/463356_1_En_1_Chapter/463356_1_En_1_Fig8_HTML.jpg](img/463356_1_En_1_Fig8_HTML.jpg)
图 1-8 在您选择了要安装的 `numpy` 包之后，点击界面右下角的绿色“应用”按钮。按钮位于界面底部右侧。

Anaconda 导航器足够智能，可以确定 `numpy` 是否需要其他包。您可能会得到一个额外的窗口，询问是否可以安装附加包。只需点击“应用”。图 1-9 显示了这个窗口的外观。

![img/463356_1_En_1_Chapter/463356_1_En_1_Fig9_HTML.jpg](img/463356_1_En_1_Fig9_HTML.jpg)
图 1-9 在安装一个包时，Anaconda 导航器会检查您想要安装的包是否依赖于尚未安装的其他包。在这种情况下，它将建议您从额外的窗口中安装缺失的（但必需的）包。在我们的例子中，新安装的系统需要 `NumPy` 库的 52 个附加包。只需点击“应用”即可安装所有这些包。
...
![img/463356_1_En_1_Chapter/463356_1_En_1_Fig10_HTML.jpg](img/463356_1_En_1_Fig10_HTML.jpg)
图 1-10 如果您在 Windows 10 的开始菜单搜索字段中输入“anaconda”，您应该至少看到两个条目：Anaconda Navigator，您在其中创建了 TensorFlow 环境，以及 Anaconda Prompt。

启动 Anaconda Prompt。应该会出现一个命令行界面（见图 1-11）。与简单的 `cmd.exe` 命令提示符不同的是，在这里，所有 Anaconda 命令都被识别，无需设置任何 Windows 环境变量。

![img/463356_1_En_1_Chapter/463356_1_En_1_Fig11_HTML.jpg](img/463356_1_En_1_Fig11_HTML.jpg)
图 1-11 选择 Anaconda Prompt 时，您应该看到的是这个。请注意，用户名将不同。您将看到不是 `umber`（我的用户名）而是您的用户名。
...
![img/463356_1_En_1_Chapter/463356_1_En_1_Fig12_HTML.jpg](img/463356_1_En_1_Fig12_HTML.jpg)
图 1-12 要在你的新环境中启动 Jupyter 笔记本，点击“tensorflow”环境名称右侧的三角形，然后点击“使用 Jupyter Notebook 打开”。
...
![img/463356_1_En_1_Chapter/463356_1_En_1_Fig13_HTML.jpg](img/463356_1_En_1_Fig13_HTML.jpg)
图 1-13 要创建一个新的笔记本，点击页面右上角的“新建”按钮，并选择 Python 3。

将会打开一个新页面，它应该看起来像图 1-14 中的那样。

![img/463356_1_En_1_Chapter/463356_1_En_1_Fig14_HTML.jpg](img/463356_1_En_1_Fig14_HTML.jpg)
图 1-14 当你创建一个空白的笔记本时，将打开一个空白的页面，它应该看起来像这样。
...
![img/463356_1_En_1_Chapter/463356_1_En_1_Fig15_HTML.jpg](img/463356_1_En_1_Fig15_HTML.jpg)
图 1-15 在单元格中输入一些代码后，按 `Shift+Enter` 将评估单元格中的代码
...
![img/463356_1_En_1_Chapter/463356_1_En_1_Fig16_HTML.png](img/463356_1_En_1_Fig16_HTML.png)
图 1-16 我们可以构建的最简单的图，显示了一个简单的变量

没那么有趣！现在让我们考虑一个稍微复杂一点的情况，比如两个变量 `x` 和 `y` 的和：`z` = `x` + `y`。它可以像以下图（图 1-17）那样完成：

![img/463356_1_En_1_Chapter/463356_1_En_1_Fig17_HTML.png](img/463356_1_En_1_Fig17_HTML.png)
图 1-17 两个变量的和的基本计算图
...
![img/463356_1_En_1_Chapter/463356_1_En_1_Fig18_HTML.png](img/463356_1_En_1_Chapter/463356_1_En_1_Fig18_HTML.png)
图 1-18
计算量 `A(x + y)` 的计算图，给定三个输入量：`x`、`y` 和 `A`

我们可以通过为输入节点（在这种情况下，`x`、`y` 和 `A`）分配值并通过图评估节点来评估这个图。例如，如果你考虑图 1-18 并将值 `x = 1`、`y = 3` 和 `A = 5` 分配给它们，我们将得到结果 `b = 20`（如图 1-19 所示）。

![img/463356_1_En_1_Chapter/463356_1_En_1_Fig19_HTML.png](img/463356_1_En_1_Chapter/463356_1_En_1_Fig19_HTML.png)
图 1-19
...
![img/463356_1_En_1_Chapter/463356_1_En_1_Fig20_HTML.png](img/463356_1_En_1_Chapter/463356_1_En_1_Fig20_HTML.png)
图 1-20
两个张量之和的计算图
...
![img/463356_1_En_1_Chapter/463356_1_En_1_Fig21_HTML.png](img/463356_1_En_1_Chapter/463356_1_En_1_Fig21_HTML.png)
图 1-21
...
![图 1-22 该节开头引用的代码构建的计算图](img/463356_1_En_1_Fig22_HTML.png)
