...
![](img/155f20fc1c4ca405f33b41c77487559e_0_0.png)
...
- E. S. Gopi，电子与通信工程系，国家技术研究所，Tiruchirappalli，泰米尔纳德邦，印度
- Amy Neustein，语言技术系统，Fort Lee，NJ，美国
- H. Vincent Poor，电气工程系，普林斯顿大学，普林斯顿，NJ，美国

本系列专注于现代信号处理方法和尖端通信技术的基础和应用。主要主题是信息和信号理论、声学信号处理、图像处理和多媒体系统、移动和无线通信、计算机和通信网络。该系列的卷册面向学术界的研究人员和工业研发部门。该系列以应用为导向。然而，每个单独卷册的呈现水平取决于主题，可以从实践到科学。

**索引：所有“信号与通信技术”中的图书都由 Scopus 和 zbMATH 索引。**

有关本书系列的一般信息、评论或建议，请联系 Mary James（mary.james@springer.com）或 Ramesh Nath Premnath（ramesh.premnath@springer.com）。

有关本系列的更多信息，请访问 https://link.springer.com/bookseries/4748
...
![](img/155f20fc1c4ca405f33b41c77487559e_3_0.png)
...
ISSN 1860-4862　　　　ISSN 1860-4870（电子版）  
信号与通信技术  
ISBN 978-981-16-6185-3　　　　ISBN 978-981-16-6186-0（电子书）  
https://doi.org/10.1007/978-981-16-6186-0

© 编辑（如适用）和作者，独家许可给 Springer Nature Singapore Pte Ltd. 2021。  
本作品受版权保护。出版商独家授权所有权，无论是整体还是部分内容，特别是翻译、重印、插图重用、朗读、广播、微缩胶片复制或以任何其他实体方式复制、传输或信息存储和检索、电子适配、计算机软件，或通过类似或不同的已知或今后开发的方法。

本出版物中使用的一般描述性名称、注册名称、商标、服务标志等，并不意味着即使在没有明确声明的情况下，这些名称不受相关保护法律和法规的约束，因此可以自由使用。

出版商、作者和编辑可以安全地假设本书中的建议和信息在出版日期时是真实准确的。出版商、作者或编辑对本书中所包含的材料不提供任何明示或暗示的保证，也不对任何错误或遗漏承担责任。出版商在已发表的地图和机构关系方面保持中立。
...
- **1 使用深度学习改变工业物联网** 1  
  ...
  - 1.1 引言 1
  - 1.2 现有框架 3
  - 1.3 物联网和工业物联网系统的分层架构 4
  - 1.4 访问控制的要求 6
    - 1.4.1 不同访问控制的方法 7
    - 1.4.2 基于能力的访问控制 8
    - 1.4.3 基于角色的访问控制 10
    - 1.4.4 基于使用情况的访问控制 12
    - 1.4.5 基于属性的访问控制 13
  - 1.5 深度学习方法 14
    - 1.5.1 工业物联网为何需要深度学习 17
  - 1.6 工业物联网系统的详细评估 19
    - 1.6.1 工业物联网中的访问控制 20
    - 1.6.2 工业物联网系统中的深度学习 22
  - 1.7 工业物联网的分析框架 22
    - 1.7.1 现有分类学回顾 22
    - 1.7.2 设备特性 24
    - 1.7.3 位置 25
...
- **2 深度学习模型及其在计算机视觉应用中的架构：一项综述** 31  
  ...
  - 2.3 深度学习模型 34
    ...
    - 2.3.2 卷积神经网络的分类 35
    - 2.3.3 ZF 网络 36
    - 2.3.4 基于区域的卷积神经网络（RCNN） 38
    - 2.3.5 Mask RCNN 38
    - 2.3.6 顺序神经网络的分类 39
    - 2.3.7 深度生成对抗网络的分类 41
    - 2.3.8 图神经网络（GNNs）的分类 42
  - 2.4 多媒体和物联网中的应用 44
  - 2.5 结论 45
  - 参考文献 45

- **3 物联网数据安全与机器学习区块链：风险和对策** 49  
  Koustav Kumar Mondal 和 Deepsubhra Guha Roy
  - 3.1 引言 49
  - 3.2 物联网中的挑战 50
    - 3.2.1 安全威胁 51
    - 3.2.2 隐私威胁 53
  - 3.3 使用机器学习算法作为解决方案的现有综述论文 54
    - 3.3.1 安全工作 54
    - 3.3.2 隐私工作 55
  - 3.4 使用区块链作为解决方案的现有综述论文 56
    - 3.4.1 安全工作 57
    - 3.4.2 隐私工作 58
  - 3.5 IoT 威胁的解决方案 59
    - 3.5.1 使用机器学习（ML）算法的现有解决方案算法 59
    - 3.5.2 使用区块链（BC）的现有解决方案技术 60
    - 3.5.3 使用机器学习（ML）和区块链（BC）的现有解决方案 63
  - 3.6 基于深度学习的物联网数据隐私和安全性 64
    - 3.6.1 深度神经网络 65
    - 3.6.2 前馈深度神经网络 66
    - 3.6.3 循环神经网络 66
    - 3.6.4 卷积神经网络 67
  ...
  - 3.7 机器学习算法分类讨论 71
  - 3.8 研究挑战 72
    - 3.8.1 物联网中的机器学习算法挑战 72
    - 3.8.2 物联网中的区块链挑战 73
    - 3.8.3 机器学习（ML）和区块链（BC）在物联网中的挑战 74
  - 3.9 结论和未来工作 76
  - 参考文献 77
...
- **5 物联网异常检测的深度学习框架启用的系统** 99  
  B. Selvakumar，S. Sridhar Raj，S. Vijay Gokul 和 B. Lakshmanan
  - 5.1 引言 99
  - 5.2 相关工作 100
  - 5.3 材料和方法 102
    - 5.3.1 数据集描述 102
    - 5.3.2 用于保护物联网网络系统的深度学习框架 103
  - 5.4 结果与讨论 107
  - 5.5 结论 107

- 参考文献 109

## 6 使用无监督机器学习进行异常检测算法 113
...
## 7 基于博弈论的隐私保护方法用于物联网中的协作深度学习 127

Deepti Gupta, Smriti Bhatt, Paras Bhatt, Maanak Gupta, 和 Ali Saman Tosun

- 7.1 引言 127
- 7.2 背景和相关工作 129
- 7.2.1 深度学习模型的信息泄漏在物联网中 129
- 7.2.2 隐私保护的深度学习 130
- 7.2.3 博弈论 131
- 7.3 物联网中的深度学习 132
- 7.3.1 卷积神经网络（CNN）132
- 7.3.2 循环神经网络（RNN）132
- 7.3.3 生成对抗网络（GAN）134
- 7.3.4 联邦深度学习（FDL）134
- 7.4 系统模型 135
- 7.4.1 物联网中的协作深度学习模型 136
- 7.4.2 边缘网关的训练成本 138
- 7.4.3 合理性假设 139
- 7.5 协作深度学习博弈 139
- 7.5.1 博弈论模型 139
...
## 8 基于深度学习的物联网安全保护：工业机器健康监测场景 151

Aneesh G. Nath 和 Sanjay Kumar Singh 151

- 8.1 引言 151
- 8.1.1 深度学习和工业物联网 152
- 8.1.2 安全和风险 152
- 8.1.3 旋转机械的安全和完整性问题：背景 153
- 8.1.4 用于案例分析的结构转子故障 154
- 8.2 框架描述 155
- 8.2.1 数据采集模块 155
- 8.2.2 特征处理 156
- 8.2.3 决策模块 157
- 8.2.4 性能检查模块 158
- 8.2.5 维护计划和纠正决策模块 159
- 8.3 工业物联网安全问题和攻击 159
- 8.3.1 深度学习处理工业物联网安全的方式 162
- 8.3.2 工业物联网安全实施的挑战 163
- 8.3.3 工业物联网安全解决方案 164
- 8.3.4 用深度学习进行工业物联网安全的 SRF 案例研究 165
- 8.4 结论 165
- 参考文献 166

## 9 深度学习模型：可理解的解释方法 169

Reenu Batra 和 Manish Mahajan 169
...
- 9.2 迄今为止的工作 171
- 9.3 深度学习方法 171
- 9.3.1 卷积神经网络（CNN）171
- 9.3.2 循环神经网络（RNN）172
- 9.3.3 去噪自编码器（DAE）173
- 9.3.4 深度置信网络（DBN）174
- 9.3.5 长短期记忆（LSTM）175
- 9.4 深度学习的重要性 176
- 9.5 深度学习的未来 177
- 9.5.1 混合学习 177
- 9.5.2 组合学习 178
