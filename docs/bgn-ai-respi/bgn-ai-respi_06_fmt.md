...
电机上的电压降：`E_L = 3 * count0 - diff`

`P = (E_resistor² / R_resistor) + E_L * I = (diff² / 5) + (3 * count0 - diff) * (diff / 5) = (diff² / 5) + (3 * count0 * diff / 5) - (diff² / 5) = (3 * count0 * diff / 5)`
