...
![img/463852_1_En_45_Fig1_HTML.jpg](img/463852_1_En_45_Fig1_HTML.jpg)
图 45-1 微服务应用程序（右）与单体应用程序（左）的比较
...
![img/463852_1_En_45_Fig2_HTML.jpg](img/463852_1_En_45_Fig2_HTML.jpg)
图 45-2 单服务器上运行的应用程序
...
![img/463852_1_En_45_Fig3_HTML.jpg](img/463852_1_En_45_Fig3_HTML.jpg)
图 45-3 虚拟机

另一方面，容器为托管具有自己的库和软件依赖项的应用程序提供了隔离的环境；然而，与 VM 不同，机器上的所有容器都共享相同的操作系统内核。`Docker` 是容器的一个例子。这如图 45-4 所示。

![img/463852_1_En_45_Fig4_HTML.jpg](img/463852_1_En_45_Fig4_HTML.jpg)
图 45-4 容器
...
![img/463852_1_En_45_Fig5_HTML.jpg](img/463852_1_En_45_Fig5_HTML.jpg)
图 45-5 部署 Docker 容器的步骤

表 45-1 展示了创建 `Dockerfile` 时的关键命令。

表 45-1 创建 Dockerfile 的命令
...
![img/463852_1_En_45_Fig6_HTML.jpg](img/463852_1_En_45_Fig6_HTML.jpg)
图 45-6 Kubernetes 组件的高级概述
...
Google Kubernetes Engine (`GKE`) 为部署应用程序容器提供了一个托管环境。要从本地 shell 在 GCP 上创建和部署资源，必须安装和配置 Google 命令行 SDK `gcloud`。如果您的机器上没有这样做，请按照 [`https://cloud.google.com/sdk/gcloud/`](https://cloud.google.com/sdk/gcloud/) 上的说明操作。否则，一个更简单的选项是使用已经安装了 `gcloud` 和 `kubectl`（`Kubernetes` 命令行界面）的 Google Cloud Shell。
...
![img/463852_1_En_45_Fig7_HTML.jpg](img/463852_1_En_45_Fig7_HTML.jpg)
图 45-7 Google Kubernetes Engine 仪表板
...
![img/463852_1_En_46_Chapter/463852_1_En_46_Fig1_HTML.jpg](img/463852_1_En_46_Chapter/463852_1_En_46_Fig1_HTML.jpg)
...
表 46-1 Kubeflow 组件示例

| 组件 | 描述 |
| :--- | :--- |
| ![img/463852_1_En_46_Chapter/463852_1_En_46_Figa_HTML.jpg](img/463852_1_En_46_Chapter/463852_1_En_46_Figa_HTML.jpg) `Chainer` | `Chainer` 是一个定义-by-run 的深度学习神经网络框架。它还支持多节点分布式深度学习和深度强化学习算法。 |
| ![img/463852_1_En_46_Chapter/463852_1_En_46_Figb_HTML.jpg](img/463852_1_En_46_Chapter/463852_1_En_46_Figb_HTML.jpg) `Jupyter` | `Jupyter` 提供了一个快速原型设计和易于共享可重复代码、方程和可视化的平台。 |
| ![img/463852_1_En_46_Chapter/463852_1_En_46_Figc_HTML.jpg](img/463852_1_En_46_Chapter/463852_1_En_46_Figc_HTML.jpg) `ksonnet` | `ksonnet` 提供了一种简单的方式来创建和编辑 Kubernetes 配置文件。`Kubeflow` 利用 `ksonnet` 来帮助管理部署。 |
| ![img/463852_1_En_46_Chapter/463852_1_En_46_Figd_HTML.jpg](img/463852_1_En_46_Chapter/463852_1_En_46_Figd_HTML.jpg) `Istio` | `Istio` 通过提供一种统一的方式来连接、安全、控制和观察服务，简化了微服务的部署。 |
| ![img/463852_1_En_46_Chapter/463852_1_En_46_Fige_HTML.jpg](img/463852_1_En_46_Chapter/463852_1_En_46_Fige_HTML.jpg) `Katib` | `Katib` 是一个深度学习无关的超参数调整框架。它受到 Google Vizier 的启发。 |
| ![img/463852_1_En_46_Chapter/463852_1_En_46_Figf_HTML.jpg](img/463852_1_En_46_Chapter/463852_1_En_46_Figf_HTML.jpg) `MXNet` | `MXNet` 是一个可移植和可扩展的深度学习库，使用多种前端语言，如 Python、Julia、MATLAB 和 JavaScript。 |
| ![img/463852_1_En_46_Chapter/463852_1_En_46_Figg_HTML.jpg](img/463852_1_En_46_Chapter/463852_1_En_46_Figg_HTML.jpg) `PyTorch` | `PyTorch` 是由 Facebook 开发的基于 Lua 编程语言的 Torch 库的 Python 深度学习库。 |
| ![img/463852_1_En_46_Chapter/463852_1_En_46_Figh_HTML.jpg](img/463852_1_En_46_Chapter/463852_1_En_46_Figh_HTML.jpg) `NVIDIA TensorRT` | `TensorRT` 是一个用于高性能和可扩展部署深度学习模型进行推理的平台。 |
| ![img/463852_1_En_46_Chapter/463852_1_En_46_Figi_HTML.jpg](img/463852_1_En_46_Chapter/463852_1_En_46_Figi_HTML.jpg) `Seldon` | `Seldon` 是一个开源平台，用于在 Kubernetes 上部署机器学习模型。 |
| ![img/463852_1_En_46_Chapter/463852_1_En_46_Figj_HTML.jpg](img/463852_1_En_46_Chapter/463852_1_En_46_Figj_HTML.jpg) `TensorFlow` | `TensorFlow` 提供了一个用于大规模生产化深度学习模型的生态系统。这包括使用 `TFJob` 进行分布式训练，使用 `TF Serving` 进行服务，以及其他 Tensorflow Extended 组件，如 TensorFlow 模型分析（`TFMA`）和 TensorFlow 转换（`TFT`）。 |

### 与 Kubeflow 一起工作

![img/463852_1_En_46_Chapter/463852_1_En_46_Fig4_HTML.jpg](img/463852_1_En_46_Chapter/463852_1_En_46_Fig4_HTML.jpg)

图 46-4 创建 OAuth 客户端 ID

![img/463852_1_En_46_Chapter/463852_1_En_46_Fig3_HTML.jpg](img/463852_1_En_46_Chapter/463852_1_En_46_Fig3_HTML.jpg)

图 46-3 GCP 凭证选项卡

![img/463852_1_En_46_Chapter/463852_1_En_46_Fig2_HTML.jpg](img/463852_1_En_46_Chapter/463852_1_En_46_Fig2_HTML.jpg)
...
2.  **创建 OAuth 客户端 ID 以标识 `Cloud IAP`：**`Kubeflow` 使用 `Cloud IAP` (Cloud Identity-Aware Proxy) 安全地连接到 `Jupyter` 和其他运行中的 Web 应用程序。`Kubeflow` 使用电子邮件地址进行身份验证。在本节中，我们将创建一个 OAuth 客户端 ID，该 ID 将用于在请求访问用户的电子邮件账户时标识 `Cloud IAP`：
...
文件 `kfctl.sh` 是 Kubeflow 安装的 shell 脚本。截至撰写本文时，最新的 Kubeflow 标签是 `v0.5.0`。
...
# Kubeflow 可在唯一的 URL 上访问

在这种情况下，Kubeflow 可在我这里通过以下 URL 访问 `https://ekaba-kubeflow-app.endpoints.oceanic-sky-230504.cloud.goog/`（见图 46-5）。再次强调，此 URL 对您的部署是唯一的。

![img/463852_1_En_46_Chapter/463852_1_En_46_Fig5_HTML.jpg](img/463852_1_En_46_Fig5_HTML.jpg)
图 46-5 Kubeflow 主页
...
![img/463852_1_En_46_Chapter/463852_1_En_46_Fig6_HTML.jpg](img/463852_1_En_46_Fig6_HTML.jpg)
图 46-6 Kubeflow 流水线仪表板
...
1. 点击名称 `[Sample] 基本条件 - 条件`（见图 46-7）。
    ...
    ![img/463852_1_En_46_Chapter/463852_1_En_46_Fig7_HTML.jpg](img/463852_1_En_46_Fig7_HTML.jpg)
    图 46-7 选择一个流水线

1. 点击 `启动实验`（见图 46-8）。

    ![img/463852_1_En_46_Chapter/463852_1_En_46_Fig8_HTML.jpg](img/463852_1_En_46_Fig8_HTML.jpg)
    图 46-8 创建一个新的实验

1. 给实验起一个名字（见图 46-9）。

    ![img/463852_1_En_46_Chapter/463852_1_En_46_Fig9_HTML.jpg](img/463852_1_En_46_Fig9_HTML.jpg)
    图 46-9 为实验分配一个名称

1. 给运行起一个名字（见图 46-10）。

    ![img/463852_1_En_46_Chapter/463852_1_En_46_Fig10_HTML.jpg](img/463852_1_En_46_Fig10_HTML.jpg)
    图 46-10 为运行分配一个名称

1. 点击 `运行名称` 以启动运行（见图 46-11）。

    ![img/463852_1_En_46_Chapter/463852_1_En_46_Fig11_HTML.jpg](img/463852_1_En_46_Fig11_HTML.jpg)
    图 46-11 运行管道
...
- `build.sh`：用于启动容器构建并将其上传到 Google Container Registry 的脚本。
- `dataflow_transform.py`：在 Cloud Dataflow 上运行 beam 管道的代码。
- `service_account.json`：用于在 GCP 上对容器进行身份验证的安全密钥。
- `local_test.sh`：用于在本地运行镜像管道组件的脚本。
...
1. 将管道上传到 Kubeflow Pipelines（图 47-1）。
    ...
    ![img/463852_1_En_47_Chapter/463852_1_En_47_Fig1_HTML.jpg](img/463852_1_En_47_Fig1_HTML.jpg)
    图 47-1 将编译后的管道上传到 Kubeflow Pipelines

1. 点击管道以查看流程的静态图（图 47-2）。

    ![img/463852_1_En_47_Chapter/463852_1_En_47_Fig2_HTML.jpg](img/463852_1_En_47_Fig2_HTML.jpg)
    图 47-2 管道摘要图

1. 创建实验并运行以执行管道（图 47-3）。

    ![img/463852_1_En_47_Chapter/463852_1_En_47_Fig3_HTML.jpg](img/463852_1_En_47_Fig3_HTML.jpg)
    图 47-3 创建并运行实验

1. 完成的管道运行（图 47-4）。

    ![img/463852_1_En_47_Chapter/463852_1_En_47_Fig4_HTML.jpg](img/463852_1_En_47_Fig4_HTML.jpg)
    图 47-4 完成的管道运行

完成的数据流管道：图 47-5 展示了管道第二个组件的完成运行，该组件是用 Cloud Dataflow 转换数据集。

![img/463852_1_En_47_Chapter/463852_1_En_47_Fig5_HTML.jpg](img/463852_1_En_47_Fig5_HTML.jpg)
图 47-5 完成数据流运行

在 Cloud MLE 上部署模型：图 47-6 展示了作为管道第五个组件的已部署模型。

![img/463852_1_En_47_Chapter/463852_1_En_47_Fig6_HTML.jpg](img/463852_1_En_47_Fig6_HTML.jpg)
图 47-6 在 Cloud MLE 上部署模型
