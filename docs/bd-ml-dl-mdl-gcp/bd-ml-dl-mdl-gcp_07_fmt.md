...
![img/463852_1_En_38_Chapter/463852_1_En_38_Fig1_HTML.jpg](img/463852_1_En_38_Fig1_HTML.jpg)
...
![img/463852_1_En_38_Chapter/463852_1_En_38_Fig2_HTML.jpg](img/463852_1_En_38_Fig2_HTML.jpg)
...
![img/463852_1_En_38_Chapter/463852_1_En_38_Fig3_HTML.jpg](img/463852_1_En_38_Fig3_HTML.jpg)
...
![img/463852_1_En_38_Chapter/463852_1_En_38_Fig4_HTML.jpg](img/463852_1_En_38_Fig4_HTML.jpg)
...
1.  激活 Cloud Shell，如图 38-5 所示。
    ...
    ![img/463852_1_En_38_Chapter/463852_1_En_38_Fig5_HTML.jpg](img/463852_1_En_38_Fig5_HTML.jpg)
...
![img/463852_1_En_38_Chapter/463852_1_En_38_Fig9_HTML.jpg](img/463852_1_En_38_Fig9_HTML.jpg)
...
1.  在导航面板中点击项目名称，然后在详细信息面板中点击 **创建数据集**（见图 38-6）。
    ...
    ![img/463852_1_En_38_Chapter/463852_1_En_38_Fig6_HTML.jpg](img/463852_1_En_38_Fig6_HTML.jpg)
...
1.  将 **DatasetID** 输入为 `crypto_data`，并将数据位置选择为 `United States (US)`（见图 38-7）。
    ...
    ![img/463852_1_En_38_Chapter/463852_1_En_38_Fig7_HTML.jpg](img/463852_1_En_38_Fig7_HTML.jpg)
...
1.  接下来，在导航面板中点击新创建的数据集，然后在详细信息面板中点击 **创建表**（见图 38-8）。
    ...
    ![img/463852_1_En_38_Chapter/463852_1_En_38_Fig8_HTML.jpg](img/463852_1_En_38_Fig8_HTML.jpg)
...
![img/463852_1_En_38_Chapter/463852_1_En_38_Fig10_HTML.jpg](img/463852_1_En_38_Fig10_HTML.jpg)
...
![img/463852_1_En_38_Chapter/463852_1_En_38_Fig11_HTML.jpg](img/463852_1_En_38_Fig11_HTML.jpg)
...
![img/463852_1_En_38_Chapter/463852_1_En_38_Fig12_HTML.jpg](img/463852_1_En_38_Fig12_HTML.jpg)
...
FROM
    ML.EVALUATE(
        MODEL `btc_crypto.market_closing_model`,
        (
            WITH
            params AS (
                SELECT
...
![img/463852_1_En_39_Chapter/463852_1_En_39_Fig1_HTML.jpg](img/463852_1_En_39_Chapter/463852_1_En_39_Fig1_HTML.jpg)
...
![img/463852_1_En_39_Chapter/463852_1_En_39_Fig3_HTML.png](img/463852_1_En_39_Fig3_HTML.png)

图 39-3

Dataprep GCS 位置设置

![img/463852_1_En_39_Chapter/463852_1_En_39_Fig2_HTML.png](img/463852_1_En_39_Fig2_HTML.png)
...
1. 我们首先通过点击 Dataprep 仪表板右上角的“创建流程”按钮来创建一个流程（见图 39-4）。输入用户定义的流程名称，然后点击“创建”，如图 39-5 所示。流程页面如图 39-6 所示。
    ...
    ![img/463852_1_En_39_Chapter/463852_1_En_39_Fig6_HTML.png](img/463852_1_En_39_Fig6_HTML.png)

    图 39-6

    流程页面

    ![img/463852_1_En_39_Chapter/463852_1_En_39_Fig5_HTML.png](img/463852_1_En_39_Fig5_HTML.png)

    图 39-5

    创建流程

    ![img/463852_1_En_39_Chapter/463852_1_En_39_Fig4_HTML.jpg](img/463852_1_En_39_Fig4_HTML.jpg)
...
1. 接下来，我们将导入并添加数据集到流程中。数据集可以直接上传到 Dataprep，然后存储到 Dataprep 在启动时生成的存储桶中。此外，Dataprep 还可以导入已存储在 BigQuery 或 GCS 中的数据集。在这种情况下，我们将导入之前转移到 Dataprep 预处理存储桶中的“crypto-market”数据集，该存储桶位于“my-dataprep-data”文件夹中（见图 39-7）。图 39-8 显示了数据集加载到 Dataprep 的过程。
    ...
    ![img/463852_1_En_39_Chapter/463852_1_En_39_Fig8_HTML.png](img/463852_1_En_39_Fig8_HTML.png)

    图 39-8

    将数据集加载到 Dataprep 中

    ![img/463852_1_En_39_Chapter/463852_1_En_39_Fig7_HTML.png](img/463852_1_En_39_Fig7_HTML.png)
...
1. 接下来，我们将创建一个配方。一个 Dataprep 配方包含用于清理和加工数据集所采取的转换步骤。这个配方随后作为 Dataflow 作业执行，以操作数据集并得出结果。点击“添加新配方”按钮来创建一个配方。该配方在图 39-9 中的红色边界框内。
    ...
    ![img/463852_1_En_39_Chapter/463852_1_En_39_Fig9_HTML.jpg](img/463852_1_En_39_Fig9_HTML.jpg)
...
1. 在本节示例中，我们将通过删除一些未使用的列然后删除数据集中除比特币加密货币之外的所有行来执行一个简单的转换过程：
    ...
    1. 删除“slug”列。在红色框内点击“添加”以删除该列（见图 39-10）。
        ...
        ![img/463852_1_En_39_Chapter/463852_1_En_39_Fig10_HTML.jpg](img/463852_1_En_39_Fig10_HTML.jpg)
    ...
    1. 删除“名称”列（见图 39-11）。
        ...
        ![img/463852_1_En_39_Chapter/463852_1_En_39_Fig11_HTML.jpg](img/463852_1_En_39_Fig11_HTML.jpg)
    ...
    1. 接下来，我们将过滤数据集中的行，仅保留比特币记录（见图 39-12 和 39-13）。
        ...
        ![img/463852_1_En_39_Chapter/463852_1_En_39_Fig13_HTML.png](img/463852_1_En_39_Fig13_HTML.png)

        图 39-13

        移除所有行（除了比特币记录）

        ![img/463852_1_En_39_Chapter/463852_1_En_39_Fig12_HTML.png](img/463852_1_En_39_Fig12_HTML.png)
...
1. 图 39-14 展示了数据集转换食谱。在图 39-14 和图 39-15 中点击“运行作业”以在 Cloud Dataflow 上运行作业。
    ...
    ![img/463852_1_En_39_Chapter/463852_1_En_39_Fig15_HTML.jpg](img/463852_1_En_39_Fig15_HTML.jpg)

    图 39-15

    在 Dataflow 上运行作业

    ![img/463852_1_En_39_Chapter/463852_1_En_39_Fig14_HTML.jpg](img/463852_1_En_39_Fig14_HTML.jpg)

    图 39-14

    查看转换食谱

1. 图 39-16 展示了正在运行的作业，图 39
...
![img/463852_1_En_40_Chapter/463852_1_En_40_Fig1_HTML.jpg](img/463852_1_En_40_Fig1_HTML.jpg)
...
![img/463852_1_En_40_Chapter/463852_1_En_40_Fig2_HTML.jpg](img/463852_1_En_40_Fig2_HTML.jpg)
...
![img/463852_1_En_41_Chapter/463852_1_En_41_Fig1_HTML.jpg](img/463852_1_En_41_Chapter/463852_1_En_41_Fig1_HTML.jpg)
...
![img/463852_1_En_41_Chapter/463852_1_En_41_Fig2_HTML.jpg](img/463852_1_En_41_Chapter/463852_1_En_41_Fig2_HTML.jpg)
...
CSV_COLUMN_DEFAULTS = [[0.0], [0.0], [0.0], [0.0], [None]]
LABEL_COLUMN = 'class'
...
![img/463852_1_En_41_Chapter/463852_1_En_41_Fig3_HTML.jpg](img/463852_1_En_41_Fig3_HTML.jpg)
...
![img/463852_1_En_41_Chapter/463852_1_En_41_Fig4_HTML.jpg](img/463852_1_En_41_Fig4_HTML.jpg)
...
![img/463852_1_En_41_Chapter/463852_1_En_41_Fig5_HTML.jpg](img/463852_1_En_41_Fig5_HTML.jpg)
...
![img/463852_1_En_41_Chapter/463852_1_En_41_Fig6_HTML.jpg](img/463852_1_En_41_Fig6_HTML.jpg)
...
This section provides the operational steps to train Scikit-learn models on Google Cloud MLE using the same Iris dataset example. We first move the appropriate data files from the GitHub repository of this book to GCS.

## Moving Data Files to GCS

Follow these steps to move the data files to GCS:

1.  Create a bucket to store the dataset.

    ```python
    gsutil mb gs://iris-sklearn
    ```

1.  Run the following command in the terminal to move the training and test datasets to the bucket:
...
**Test samples for online prediction.**
...
The code to train Scikit-learn models on Cloud MLE is already prepared as a Python package. The project structure is as follows:

Iris_SklearnCloudML: [The name of the parent folder of the project]

+   Trainer: [The folder containing the model and execution code]

    +   __init__.py: [An empty special Python file that represents the folder as a Python package]

    +   model.py: [The file containing the model logic written using Scikit-learn]

+   scripts: [The folder containing the scripts to execute jobs on Cloud MLE]

    +   single-instance-training.sh: [The script to run a single-instance training job on Cloud MLE]

    +   online-prediction.sh: [The script to execute an online prediction job on Cloud MLE]

    +   create-prediction-service.sh: [The script to create a prediction service on Cloud MLE]

+   config.yaml: [The configuration file specifying the model version]

The model code for training Scikit-learn on Cloud MLE, as shown below, is stored in the file 'model.py'. The machine learning algorithm used in this model is the random forest classifier.
...
Note the following points in the following code block:

+   The code uses the 'file_io' module from the package 'tensorflow.python.lib.io' to stream files stored in Cloud Storage.

+   The rest of the code block runs the classifier to build the model and exports the model to a storage bucket location on GCS. When building the prediction service for online prediction, Cloud MLE will read from this bucket.

## Executing Scikit-learn Training Jobs on Cloud MLE

The following shows the bash code used to execute Scikit-learn model training jobs and is saved in the file 'single-instance-training.sh'.
...
## Creating Scikit-learn Prediction Service on Cloud MLE

The code to create a prediction service is as follows and is saved in the file 'create-prediction-service.sh'.
...
The above code references a configuration file 'config.yaml'. This file (as shown below) contains the configuration of the Scikit-learn model. Let's briefly review the listed properties:

+   deploymentUri: This points to the storage bucket location of the Scikit-learn model.

+   runtimeVersion: This attribute specifies the Cloud MLE runtime version.

+   framework: This attribute is particularly important as it specifies the model framework being used; this can be SCIKIT_LEARN, XGBOOST, or TENSORFLOW. For this example, it is set to SCIKIT_LEARN.

+   pythonVersion: This attribute specifies the Python version being used.

The definition of 'config.yaml' is as follows:
...
## Online Prediction from Scikit-learn Model

The code for online prediction from the Scikit-learn model is as follows and is stored in the file 'online-prediction.sh'. In online prediction, input data is passed directly as a JSON string.
...
The following shows the input data stored as a JSON string.

```json
[5.1, 3.5, 1.4, 0.2]
```

Run the following command to execute an online prediction request to the model hosted on Cloud MLE.
...
In this chapter, we discussed training large-scale models using Google Cloud Machine Learning Engine, which is part of the Google AI Platform. In the examples in this chapter, we trained models using the Estimator advanced API and Scikit-learn. It is important to note that the Keras advanced API can also be used to train large-scale models on Cloud MLE.

In the next chapter, we will introduce training custom image recognition models using Google Cloud AutoML.
...
1.  通过点击 GCP 仪表板左上角的三个横线打开云视觉。如图 42-1 所示，在**人工智能**产品部分下选择**视觉**。
    ...
    ![img/463852_1_En_42_Chapter/463852_1_En_42_Fig1_HTML.jpg](img/463852_1_En_42_Fig1_HTML.jpg)

    图 42-1 打开 Google AutoML：云视觉

1.  选择如图 42-2 和 42-3 所示的 Google 用户账户以激活 AutoML。

    ![img/463852_1_En_42_Chapter/463852_1_En_42_Fig3_HTML.jpg](img/463852_1_En_42_Fig3_HTML.jpg)

    图 42-3 验证 AutoML

    ![img/463852_1_En_42_Chapter/463852_1_En_42_Fig2_HTML.jpg](img/463852_1_En_42_Fig2_HTML.jpg)

    图 42-2 选择用于验证 AutoML 的账户

1.  验证后，将打开 Google Cloud Vision 欢迎页面（见图 42-4）。

    ![img/463852_1_En_42_Chapter/463852_1_En_42_Fig4_HTML.jpg](img/463852_1_En_42_Fig4_HTML.jpg)

    图 42-4 云视觉欢迎页面

1.  从下拉菜单中选择将用于设置 AutoML 的**项目 ID**（已启用计费）（见图 42-5）。

    ![img/463852_1_En_42_Chapter/463852_1_En_42_Fig5_HTML.jpg](img/463852_1_En_42_Fig5_HTML.jpg)

    图 42-5 选择用于配置 AutoML 的项目 ID

1.  最后一步配置是在 GCP 项目上启用 AutoML API 并创建一个 GCS 存储桶以存储输出模型。点击**“立即设置”**以自动完成配置，如图 42-6 所示。

    ![img/463852_1_En_42_Chapter/463852_1_En_42_Fig6_HTML.jpg](img/463852_1_En_42_Fig6_HTML.jpg)

    图 42-6 自动完成 AutoML 配置

1.  当配置完成后，AutoML Vision 仪表板被激活（见图 42-7）。

    ![img/463852_1_En_42_Chapter/463852_1_En_42_Fig7_HTML.jpg](img/463852_1_En_42_Fig7_HTML.jpg)

    图 42-7 自动完成 AutoML 配置
...
1.  从 Cloud AutoML Vision 仪表板，如图 42-8 所示，点击**新建数据集**。
    ...
    ![img/463852_1_En_42_Chapter/463852_1_En_42_Fig8_HTML.jpg](img/463852_1_En_42_Fig8_HTML.jpg)

    图 42-8 在 AutoML Vision 上创建新数据集
...
1.  要在 Cloud AutoML Vision 上创建数据集，设置以下参数，如图 42-9 所示：
    ...
    1.  点击**创建数据集**开始导入图像（见图 42-10）。
        ...
        ![img/463852_1_En_42_Chapter/463852_1_En_42_Fig10_HTML.jpg](img/463852_1_En_42_Fig10_HTML.jpg)

        图 42-10 Cloud AutoML Vision：导入图像

    ![img/463852_1_En_42_Chapter/463852_1_En_42_Fig9_HTML.jpg](img/463852_1_En_42_Fig9_HTML.jpg)

    图 42-9 在 Cloud AutoML Vision 上创建数据集

1.  导入数据集后，点击**训练**（见图 42-11）以启动构建自定义图像识别模型的过程。

    ![img/463852_1_En_42_Chapter/463852_1_En_42_Fig11_HTML.jpg](img/463852_1_En_42_Fig11_HTML.jpg)

    图 42-11 Cloud AutoML Vision：导入的图像及其标签
...
1.  在机器学习中，更多的标记训练示例可以提高模型的性能。同样，在使用 AutoML 时，每个图像类至少应有 100 个训练示例。在本节使用的示例中，某些类别的示例不足 100 个，因此 AutoML 会发出警告，如图 42-12 所示。然而，为了完成这个练习，我们将继续进行训练。点击**开始训练**。
    ...
    ![img/463852_1_En_42_Chapter/463852_1_En_42_Fig12_HTML.jpg](img/463852_1_En_42_Fig12_HTML.jpg)

    图 42-12 Cloud AutoML Vision 请求每个图像类更多的训练示例

1.  选择模型训练的时长。更长的训练时间可能会影响模型精度，但这可能会在 Cloud AutoML 的机器上运行时增加成本（见图 42-13）。再次点击**开始训练**以开始构建模型（见图 42-14）。

    ![img/463852_1_En_42_Chapter/463852_1_En_42_Fig14_HTML.jpg](img/463852_1_En_42_Fig14_HTML.jpg)

    图 42-14 在 Cloud AutoML Vision 上训练视觉模型

    ![img/463852_1_En_42_Chapter/463852_1_En_42_Fig13_HTML.jpg](img/463852_1_En_42_Fig13_HTML.jpg)

    图 42-13 选择训练预算

1.  训练摘要显示在图 42-15 中。

    ![img/463852_1_En_42_Chapter/463852_1_En_42_Fig15_HTML.jpg](img/463852_1_En_42_Fig15_HTML.jpg)

    图 42-15 Cloud AutoML Vision：训练摘要

1.  AutoML Vision 使用预留的测试图像来评估训练后的模型质量，如图 42-16 所示。显示精确度和召回率之间权衡的 F1 图如图 42-17 所示。此外，还提供了一个可视化的混淆矩阵以进一步评估模型质量（见图 42-18）。

    ![img/463852_1_En_42_Chapter/463852_1_En_42_Fig18_HTML.png](img/463852_1_En_42_Fig18_HTML.png)

    图 42-18 Cloud AutoML Vision 上模型评估的混淆矩阵

    ![img/463852_1_En_42_Chapter/463852_1_En_42_Fig17_HTML.jpg](img/463852_1_En_42_Fig17_HTML.jpg)

    图 42-17 Cloud AutoML Vision 上的 F1 评估矩阵

    ![img/463852_1_En_42_Chapter/463852_1_En_42_Fig16_HTML.jpg](img/463852_1_En_42_Fig16_HTML.jpg)

    图 42-16 Cloud AutoML Vision：模型评估

1.  定制的图像识别模型作为 REST 或 Python API 公开，以便作为预测服务集成到软件应用程序中（见图 42-19）。我们可以通过上传一个用于分类的样本图像来测试我们的模型，如图 42-20 所示。

    ![img/463852_1_En_42_Chapter/463852_1_En_42_Fig20_HTML.jpg](img/463852_1_En_42_Fig20_HTML.jpg)

    图 42-20 在 Cloud AutoML Vision 上测试预测服务

    ![img/463852_1_En_42_Chapter/463852_1_En_42_Fig19_HTML.png](img/463852_1_En_42_Fig19_HTML.png)

    图 42-19 Cloud AutoML Vision：作为预测服务的模型

1.  要删除一个模型，点击三个短横线并选择“模型”以导航到模型仪表板（见图 42-21）。在模型旁边点击三个点，然后选择“删除模型”（见图 42-22）。如图 42-23 所示确认删除。然而，请注意，与已删除模型相关的 API 调用将停止运行。

    ![img/463852_1_En_42_Chapter/463852_1_En_42_Fig23_HTML.jpg](img/463852_1_En_42_Fig23_HTML.jpg)

    图 42-23 在 Cloud AutoML Vision 上删除一个模型

    ![img/463852_1_En_42_Chapter/463852_1_En_42_Fig22_HTML.jpg](img/463852_1_En_42_Fig22_HTML.jpg)

    图 42-22 选择要删除的模型

    ![img/463852_1_En_42_Chapter/463852_1_En_42_Fig21_HTML.jpg](img/463852_1_En_42_Fig21_HTML.jpg)
...
本章将构建一个语言毒性分类模型，使用 Google Cloud AutoML 进行自然语言处理（NLP），以对有毒和无毒


# 在接下来的屏幕上，点击**开始使用 AutoML**（见图 43-2）。

![img/463852_1_En_43_Chapter/463852_1_En_43_Fig2_HTML.jpg](img/463852_1_En_43_Chapter/463852_1_En_43_Fig2_HTML.jpg)

图 43-2

# 点击**立即设置**来自动设置用于与 Cloud AutoML NLP 一起工作的 GCP 项目（见图 43-3）。此过程涉及激活 AutoML API 并在 GCP 上创建一个存储数据输入和输出模型的存储桶。我们将在下一节中使用此存储桶。

![img/463852_1_En_43_Chapter/463852_1_En_43_Fig3_HTML.jpg](img/463852_1_En_43_Chapter/463852_1_En_43_Fig3_HTML.jpg)

图 43-3

# 配置后，Cloud AutoML NLP 仪表板被激活（见图 43-4）。

![img/463852_1_En_43_Chapter/463852_1_En_43_Fig4_HTML.png](img/463852_1_En_43_Chapter/463852_1_En_43_Fig4_HTML.png)
...
1. 从 Cloud AutoML NLP 仪表板，如图 43-5 所示，点击 **NEW DATASET**。
    ...
    ![img/463852_1_En_43_Chapter/463852_1_En_43_Fig5_HTML.jpg](img/463852_1_En_43_Chapter/463852_1_En_43_Fig5_HTML.jpg)
...
1. 要在 Cloud AutoML NLP 上创建数据集，请设置以下参数，如图 43-6 所示：
    ...
    1. 点击 **CREATE DATASET** 开始导入图像（见图 43-7）。
        ...
        ![img/463852_1_En_43_Chapter/463852_1_En_43_Fig8_HTML.jpg](img/463852_1_En_43_Chapter/463852_1_En_43_Fig8_HTML.jpg)

        图 43-8

        ![img/463852_1_En_43_Chapter/463852_1_En_43_Fig7_HTML.jpg](img/463852_1_En_43_Chapter/463852_1_En_43_Fig7_HTML.jpg)

        图 43-7

    ![img/463852_1_En_43_Chapter/463852_1_En_43_Fig6_HTML.jpg](img/463852_1_En_43_Chapter/463852_1_En_43_Fig6_HTML.jpg)
...
1. 在本例中，我们拥有足够的训练示例，如图 43-9 所示，因此有理由期待一个良好的语言分类模型。点击 **START TRAINING** 开始训练任务。
    ...
    ![img/463852_1_En_43_Chapter/463852_1_En_43_Fig9_HTML.jpg](img/463852_1_En_43_Chapter/463852_1_En_43_Fig9_HTML.jpg)

    图 43-9

1. 接受默认模型名称，并点击 **START TRAINING**（见图 43-10）以开始构建模型，如图 43-11 所示。请注意，这次训练可能需要大约一个小时才能完成。完成后，用户将收到完成通知的电子邮件。

    ![img/463852_1_En_43_Chapter/463852_1_En_43_Fig11_HTML.jpg](img/463852_1_En_43_Chapter/463852_1_En_43_Fig11_HTML.jpg)

    图 43-11

    ![img/463852_1_En_43_Chapter/463852_1_En_43_Fig10_HTML.jpg](img/463852_1_En_43_Chapter/463852_1_En_43_Fig10_HTML.jpg)

    图 43-10

1. 训练摘要如图 43-12 所示。训练阶段持续了大约 4 小时 45 分钟。

    ![img/463852_1_En_43_Chapter/463852_1_En_43_Fig12_HTML.jpg](img/463852_1_En_43_Chapter/463852_1_En_43_Fig12_HTML.jpg)

    图 43-12

1. AutoML NLP 在训练后为了评估模型的质量，将一部分文档留作测试集（见图 43-13）。F1 图显示了精确度和召回率之间的权衡。此外，混淆矩阵提供了对模型质量的进一步洞察（见图 43-14))。

    ![img/463852_1_En_43_Chapter/463852_1_En_43_Fig14_HTML.jpg](img/463852_1_En_43_Chapter/463852_1_En_43_Fig14_HTML.jpg)

    图 43-14

    ![img/463852_1_En_43_Chapter/463852_1_En_43_Fig13_HTML.jpg](img/463852_1_En_43_Chapter/463852_1_En_43_Fig13_HTML.jpg)
...
1. 自定义文本分类模型作为 REST 或 Python API 暴露出来，以便将其集成到软件应用程序中作为预测服务（见图 43-15）。我们可以通过上传一个用于分类的样本图像来测试我们的模型。图 43-16 将一个清洁文本示例传递给模型，并正确预测，概率为 98%，而图 43-17 将一个有毒文本示例传递给模型。此示例也被正确分类，概率得分为 99%。
    ...
    ![img/463852_1_En_43_Chapter/463852_1_En_43_Fig17_HTML.jpg](img/463852_1_En_43_Chapter/463852_1_En_43_Fig17_HTML.jpg)

    图 43-17

    ![img/463852_1_En_43_Chapter/463852_1_En_43_Fig16_HTML.jpg](img/463852_1_En_43_Chapter/463852_1_En_43_Fig16_HTML.jpg)

    图 43-16

    ![img/463852_1_En_43_Chapter/463852_1_En_43_Fig15_HTML.jpg](img/463852_1_En_43_Chapter/463852_1_En_43_Fig15_HTML.jpg)

    图 43-15

1. 本章介绍了使用 Google AutoML Cloud Vision 构建和部署自定义文本分类模型。在下一章中，我们将在 GCP 上构建一个端到端的数据科学产品。
...
![img/463852_1_En_44_Chapter/463852_1_En_44_Fig1_HTML.jpg](img/463852_1_En_44_Chapter/463852_1_En_44_Fig1_HTML.jpg)
...
![img/463852_1_En_44_Chapter/463852_1_En_44_Fig2_HTML.jpg](img/463852_1_En_44_Chapter/463852_1_En_44_Fig2_HTML.jpg)
...
![img/463852_1_En_44_Chapter/463852_1_En_44_Fig3_HTML.jpg](img/463852_1_En_44_Chapter/463852_1_En_44_Fig3_HTML.jpg)

图 44-3 机器学习算法的 RMSE 估计
...
+   Create a `requirements.txt` file to install dependencies on the Dataflow worker (in this example, tensorflow_transform).
...
+   The following code block uses Apache Beam to build a data preprocessing pipeline that converts the raw dataset into a format suitable for building predictive models. The transformation is the same as that performed on the reduced dataset, including removing highly correlated columns and scaling the dataset's numerical values to the same range. The output of the Beam pipeline produces a training set and an evaluation set. The Beam pipeline also uses TensorFlow Transform to save metadata of the data transformation (including original and processed), as well as a transformation graph that can be used later for deployment as a model service function. We created this example to include a reference usage of TensorFlow Transform.
...
![img/463852_1_En_44_Chapter/463852_1_En_44_Fig4_HTML.jpg](img/463852_1_En_44_Fig4_HTML.jpg)

Figure 44-4

Data flow pipeline diagram

+   The data flow pipeline diagram is shown in Figure 44-4.
...
def cleanup(rowdict):
    ...
    row = ('{}' + ',{}' * (len(result) - 1)).format(result['number_of_elements'], result['mean_atomic_mass'],
                                                   result['entropy_atomic_mass'], result['wtd_entropy_atomic_mass'],
                                                   result['range_atomic_mass'], result['wtd_range_atomic_mass'],
                                                   result['mean_fie'], result['wtd_mean_fie'],
                                                   result['wtd_entropy_fie'], result['range_fie'],
                                                   result['wtd_range_fie'], result['mean_atomic_radius'],
                                                   result['wtd_mean_atomic_radius'],
                                                   result['range_atomic_radius'], result['wtd_range_atomic_radius'],
                                                   result['mean_Density'], result['entropy_Density'],
                                                   result['wtd_entropy_Density'], result['range_Density'],
                                                   result['wtd_range_Density'], result['mean_ElectronAffinity'],
                                                   result['wtd_entropy_ElectronAffinity'],
                                                   result['range_ElectronAffinity'], result['wtd_range_ElectronAffinity'],
                                                   result['mean_FusionHeat'], result['gmean_FusionHeat'],
                                                   result['entropy_FusionHeat'], result['wtd_entropy_FusionHeat'],
                                                   result['range_FusionHeat'], result['wtd_range_FusionHeat'],
                                                   result['mean_ThermalConductivity'],
                                                   result['wtd_mean_ThermalConductivity'],
                                                   result['gmean_ThermalConductivity'],
                                                   result['entropy_ThermalConductivity'],
                                                   result['wtd_entropy_ThermalConductivity'],
                                                   result['range_ThermalConductivity'], result['wtd_range_ThermalConductivity'],
                                                   result['mean_Valence'], result['wtd_mean_Valence'],
                                                   result['range_Valence'], result['wtd_range_Valence'],
                                                   result['wtd_std_Valence'], result['critical_temp'])
    yield row
...
![img/463852_1_En_44_Chapter/463852_1_En_44_Fig5_HTML.jpg](img/463852_1_En_44_Fig5_HTML.jpg)
