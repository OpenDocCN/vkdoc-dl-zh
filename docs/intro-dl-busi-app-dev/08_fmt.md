...
*   廖等人提出了一种技术( [`https://arxiv.org/pdf/1705.01088.pdf`](https://arxiv.org/pdf/1705.01088.pdf) )用于跨具有不同外观但感知语义结构相似的图像的视觉属性转移。他们将该技术称为深度图像类比，其中使用由粗到细的策略来计算最近邻场以生成结果。他们将其应用于风格/纹理转换、颜色/风格交换、素描/绘画到照片以及时间推移。
