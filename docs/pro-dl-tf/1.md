...
线性代数是数学的一个分支，研究向量及其从一个向量空间到另一个向量空间的变换。由于在机器学习和深度学习中，我们处理多维数据及其操作，所以线性代数在几乎每个机器学习和深度学习算法中都起着至关重要的作用。图 1-2 所示为三维向量空间，其中 v <sub>1</sub> ，v <sub>2</sub> ，v <sub>3</sub> 为向量，P 为三维向量空间内的二维平面。
...
矩阵是按行和列排列的二维数字数组。矩阵的大小由其行长和列长决定。如果一个矩阵 A 有 m 行 n 列，可以表示为一个具有![$$ m\times n $$](img/A448418_1_En_1_Chapter_IEq1.gif)元素的矩形对象(见图 1-4a )，可以记为![$$ {A}_{m\times n} $$](img/A448418_1_En_1_Chapter_IEq2.gif)。
...
??![$$ where\kern0.5em a{\hbox{'}}_{ji}\ \in {A}^T\ and\ {a}_{ij}\ \in A $$](img/A448418_1_En_1_Chapter_Equl.gif)
...
平行四边形的面积= |u||v| sin θ其中θθ是 u 和 v 之间的角度(见图 1-6 )。![$$ = \sqrt{a² + {b}²}\sqrt{c² + {d}²}\frac{\left( ad-bc\right)}{\sqrt{a² + {b}²}\sqrt{c² + {d}²}}=\left( ad-bc\right) $$](img/A448418_1_En_1_Chapter_Equac.gif)
...
![$$ \left\Vert {x}_2\right\Vert {\left({\left|{x}_1\right|}² + {\left|{x}_2\right|}² + \dots + {\left|{x}_n\right|}²\ \right)}^{1/2}\kern0.75em = {(x.x)}^{1/2} = {\left({x}^Tx\right)}^{1/2} $$](img/A448418_1_En_1_Chapter_Equah.gif)

同样，l <sup>1</sup> 范数是矢量分量的绝对值之和。![$$ {\left\Vert x\right\Vert}_1 = \left|{x}_1\left| + \right|{x}_2\left| + \dots + \right|{x}_n\right| $$](img/A448418_1_En_1_Chapter_Equai.gif)
...
在图 1-7 中，绘制了 l <sup>1</sup> ，l <sup>2</sup> 和上确界范数的单位范数曲线。
...
在图 1-8 中，线段 OA 的长度给出了矢量 v <sub>1</sub> 在 v <sub>2</sub> 上的投影长度。
...
![$$ \left|\begin{array}{cc}\hfill -\lambda \hfill & \hfill 1\hfill \\ {}\hfill -2\hfill & \hfill -3 - \lambda \hfill \end{array}\right|=0\kern1em =>{\lambda}²+3\lambda +2=0 = > \lambda = -2,-1 $$](img/A448418_1_En_1_Chapter_Equar.gif)

两个特征值是![$$ -2 $$](img/A448418_1_En_1_Chapter_IEq110.gif)和![$$ -1 $$](img/A448418_1_En_1_Chapter_IEq111.gif)。

设![$$ -2 $$](img/A448418_1_En_1_Chapter_IEq112.gif)的特征值对应的特征向量为![$$ u = {\left[a\ b\right]}^T $$](A448418_1_En_1_Chapter_IEq113.gif)。![$$ \left[\begin{array}{cc}\hfill 0\hfill & \hfill 1\hfill \\ {}\hfill -2\hfill & \hfill -3\hfill \end{array}\right]\left[\begin{array}{c}\hfill a\hfill \\ {}\hfill b\hfill \end{array}\right] = -2\left[\begin{array}{c}\hfill a\hfill \\ {}\hfill b\hfill \end{array}\right] $$](A448418_1_En_1_Chapter_Equas.gif)
...
![$$ \frac{dy}{dx}\left(f(x)\right) = \frac{dy}{dx}\left({e}^{ax}\right) = \kern0.5em a{e}^{ax} $$](img/A448418_1_En_1_Chapter_Equav.gif)
...
![$$ v = {k}_1{v}_1 + {k}_2{v}_2 + .\ . + {k}_n{v}_n $$](img/A448418_1_En_1_Chapter_IEq130.gif)其中![$$ {k}_i\kern0.75em \forall\ i\ \in \left\{1,2,3,..n\right\} $$](img/A448418_1_En_1_Chapter_IEq131.gif)为常数。![$$ \begin{array}{l}{v}^{\left(k+1\right)}={A}^kv = {A}^k\left({k}_1{v}_1 + {k}_2{v}_2 + .\ . + {k}_n{v}_n\right)\\ {}\kern3.5em ={k}_1{A}^k{v}_1 + {k}_{2\ }{A}^k{v}_2 + .\ . + {k}_n{A}^k{v}_n\\ {}\kern3.5em ={k}_1{\lambda_1}^k{v}_1 + {k}_{2\ }{\lambda_2}^k{v}_2 + .\ . + {k}_n{\lambda_n}^k{v}_n\\ {}\kern3.5em ={\lambda_1}^k\left({k}_1{v}_1 + {k}_{2\ }{\left(\frac{\lambda_2}{\lambda_1}\right)}^k{v}_2 + .\ . + {k}_n{\left(\frac{\lambda_n}{\lambda_1}\right)}^k{v}_n\right)\end{array} $$](img/A448418_1_En_1_Chapter_Equay.gif)
...
让我们假设一个粒子在一维平面上运动——即直线——并且它在任何特定时间的距离由函数![$$ f(t) = 5{t}²\. $$](img/A448418_1_En_1_Chapter_IEq134.gif)定义
...
比如一个三变量![$$ f\left(x,y,z\right)=x+{y}²+{z}³ $$](img/A448418_1_En_1_Chapter_IEq141.gif)的函数的梯度由
...
*   f(x)的二阶导数，无非是用![$$ \frac{d^{2\ }f(x)}{d{x}²} $$](img/A448418_1_En_1_Chapter_IEq143.gif)表示的一阶导数的导数，需要在一阶导数为零的点上考察。如果二阶导数小于零，那么它是一个最大值点，而如果它大于零，它是一个最小值点。如果二阶导数也是零，那么这个点就叫做拐点。

就拿一个很简单的函数来说，![$$ y = f(x) = {x}² $$](img/A448418_1_En_1_Chapter_IEq144.gif)。如果我们对函数 w . r . t xan 求导，并将其设为零，我们得到![$$ \frac{dy}{dx} = 2x = 0 $$](img/A448418_1_En_1_Chapter_IEq145.gif)，这就给出了![$$ x = 0 $$](img/A448418_1_En_1_Chapter_IEq146.gif)。还有，二阶导数![$$ \frac{d^{2\ }y}{d{x}²} = 2 $$](img/A448418_1_En_1_Chapter_IEq147.gif)。因此，对于 x 的所有值，包括![$$ x=0 $$](img/A448418_1_En_1_Chapter_IEq148.gif)，二阶导数大于零，因此![$$ x=0 $$](img/A448418_1_En_1_Chapter_IEq149.gif)是函数 f(x)的最小值点。

让我们对![$$ y = g(x) = \kern0.5em {x}³ $$](img/A448418_1_En_1_Chapter_IEq150.gif)做同样的练习。

![$$ \frac{dy}{dx} = 3{x}²=0 $$](img/A448418_1_En_1_Chapter_IEq151.gif)给了我们![$$ x = 0 $$](img/A448418_1_En_1_Chapter_IEq152.gif)。二阶导数![$$ \frac{d^{2\ }y}{d{x}²} = 6x $$](img/A448418_1_En_1_Chapter_IEq153.gif)，如果我们在![$$ x = 0 $$](img/A448418_1_En_1_Chapter_IEq154.gif)求它，我们得到 0。所以，![$$ x = 0 $$](img/A448418_1_En_1_Chapter_IEq155.gif)既不是函数 g(x)的极小点，也不是最大点。二阶导数为零的点称为拐点。在拐点处，曲率的符号发生变化。
...
*   如果![$$ {f}_{xx}{f}_{yy}\ \hbox{--} {\left({f}_{xy}\right)}² < 0\ at\ \left(x=a,y=b\right) $$](img/A448418_1_En_1_Chapter_IEq161.gif)那么![$$ \left(x=a,y=b\right) $$](img/A448418_1_En_1_Chapter_IEq162.gif)就是鞍点。
*   如果![$$ {f}_{xx}{f}_{yy}\ \hbox{--} {\left({f}_{xy}\right)}²>\kern0.5em 0\ at\ \left(x=a,y=b\right) $$](img/A448418_1_En_1_Chapter_IEq163.gif)那么![$$ \left(x=a,y=b\right) $$](img/A448418_1_En_1_Chapter_IEq164.gif)是极值点；即存在最大值或最小值。
...
*   如果![$$ {f}_{xx}{f}_{yy}\ \hbox{--} {\left({f}_{xy}\right)}² = 0 $$](img/A448418_1_En_1_Chapter_IEq170.gif)那么需要更先进的方法来正确地分类静止点。
...
![$$ f\left(x,\ y\right) = 2{x}² + 3{y}² - 5 $$](img/A448418_1_En_1_Chapter_IEq182.gif)是在![$$ x=0,y=0 $$](img/A448418_1_En_1_Chapter_IEq183.gif)处有最小值的凸函数，f(x，y)在![$$ \left(x=0,y=0\right) $$](img/A448418_1_En_1_Chapter_IEq184.gif)处的最小值为![$$ -5 $$](img/A448418_1_En_1_Chapter_IEq185.gif)。该功能绘制在图 1-16 中以供参考。

![A448418_1_En_1_Fig17_HTML.gif](img/A448418_1_En_1_Fig17_HTML.gif)

图 1-16

Plot of the convex function ![$$ 2{x}² + 3{y}² - 5 $$](img/A448418_1_En_1_Chapter_IEq186.gif)
...
黑森的特征值是![$$ -\frac{1}{x²} $$](img/A448418_1_En_1_Chapter_IEq188.gif)和![$$ \frac{1}{y²} $$](img/A448418_1_En_1_Chapter_IEq189.gif)。![$$ -\frac{1}{x²} $$](img/A448418_1_En_1_Chapter_IEq190.gif)对于实 x 总是负的。因此，Hessian 不是正半定的，使得函数非凸。
...
![$$ f\left(x+h\right)=f(x)+h{f}^{\prime }(x) + \frac{1}{2!}{h}²{f}^{{\prime\prime} }(x) + \frac{1}{3!}{h}³{f}^{{\prime\prime\prime} }(x) + .\ . + \frac{1}{n!}{h}^n{f}^n(x) + .. $$](img/A448418_1_En_1_Chapter_Equbu.gif)
...
*   如果函数在 x 的邻域内是二次的，那么对于位于二次区域内的任意点![$$ \left(x + h\right) $$](img/A448418_1_En_1_Chapter_IEq194.gif)，![$$ f\left(x+h\right)=f(x)+h{f}^{\prime }(x) + \frac{1}{2!}{h}²{f}^{{\prime\prime} }(x) $$](img/A448418_1_En_1_Chapter_IEq195.gif)。
...
![$$ \begin{array}{l}P(AUB)\kern0.75em = P\left(A\ \hbox{--}\ B\right) + P\left(B\ \hbox{--}\ A\right) + P(AB)\\ {}\kern4.25em = P(A) - P(AB) + P(B)\ \hbox{--}\ P(AB) + P(AB)\\ {}\kern4.25em = P(A) + P(B) - P(AB)\end{array} $$](img/A448418_1_En_1_Chapter_Equcd.gif)
...
为了使 P(x)成为概率密度函数，![$$ {\displaystyle {\int}_{x=0}¹P(x)dx} $$](img/A448418_1_En_1_Chapter_IEq221.gif)应该是 1。

![$$ {\displaystyle {\int}_{x=0}¹P(x)dx = }\ {\displaystyle {\int}_{x=0}¹²xdx\kern0.5em ={\left[{x}²\right]}_0¹=1} $$](A448418_1_En_1_Chapter_IEq222.gif)。因此，P(x)是一个概率密度函数。
...
![$$ Var\left[X\right] = E\left[{\left(X-\mu \right)}²\right] $$](A448418_1_En_1_Chapter_IEq225.gif)其中![$$ \mu = E\left[X\right] $$](A448418_1_En_1_Chapter_IEq226.gif)
...
![$$ = {\displaystyle \sum_{i=1}^n}{\left({x}_i - \mu \right)}²{p}_i $$](img/A448418_1_En_1_Chapter_Equcr.gif)
...
其中μ为均值，σ <sup>2</sup> 为随机变量 x 的方差，图 1-26 所示为一元正态分布的概率密度函数。
...
图 1-28 所示为具有![$$ n=4 $$](img/A448418_1_En_1_Chapter_IEq241.gif)和![$$ p = 0.3 $$](img/A448418_1_En_1_Chapter_IEq242.gif)的二项分布的概率质量函数。
...
图 1-29 所示为具有![$$ \lambda =15 $$](img/A448418_1_En_1_Chapter_IEq243.gif)均值的泊松分布的概率质量函数。
...
![$$ {x}_i \sim Normal\left(\mu,\ {\sigma}²\right) $$](img/A448418_1_En_1_Chapter_IEq244.gif)中的每一个，因此可能性可以进一步展开为:
...
对于每个人头，来自伯努利分布的概率是![$$ P\left({x}_i=1/\ p\right) = {p}¹{\left(1 - p\right)}⁰ = p $$](img/A448418_1_En_1_Chapter_IEq245.gif)。类似地，对于每条尾巴，概率是![$$ P\left({x}_i=0/\ p\right) = {p}⁰{\left(1 - p\right)}¹ = 1 - p $$](img/A448418_1_En_1_Chapter_IEq246.gif)。因为我们有 77 个头和 33 条尾巴，我们得到可能性 L(p)是 p<sup>7</sup>(1–p)<sup>3</sup>。
...
用![$$ \overline{x} $$](img/A448418_1_En_1_Chapter_IEq253.gif)表示的样本均值服从正态分布，均值为μ，方差为![$$ \frac{\sigma²}{n} $$](img/A448418_1_En_1_Chapter_IEq254.gif)；即，
...
人们应该选择的 I 型误差α取决于人们对进行测试的具体领域的了解。一般来说，![$$ \alpha =0.05 $$](img/A448418_1_En_1_Chapter_IEq265.gif)是一个足够好的类型 1 错误设置。由于计算出的 p 值小于测试中规定的 I 型误差，我们不能接受零假设。我们说这个测试有统计学意义。p 值如图 1-31 所示。
...
设输入特征向量用 x’表示，预测值为 y <sub>p</sub> 。假设房价的实际值(即输出标注)由 y 表示。我们可以定义一个模型，其中输出标注表示为输入要素向量的函数，如下式所示。该模型由我们希望通过训练过程学习的几个常数来参数化。![$$ y/{x}^{\prime } = {\theta^{\prime}}^T{x}^{\prime } + b+\epsilon $$](img/A448418_1_En_1_Chapter_Equeg.gif)

其中ϵ是预测和![$$ \epsilon \sim Normal\Big(0,{\sigma}² $$](img/A448418_1_En_1_Chapter_IEq270.gif)中的随机变量。
...
从图 1-37 中我们可以看到，在点θ <sub>1</sub> 处的梯度(在这种情况下只是导数)是正的，因此如果我们沿着梯度方向移动，成本函数将会增加。相反，在θ <sub>1</sub> 处，如果我们沿着梯度的负值移动，成本会降低。还是那句话，我们取梯度为负的点θ <sub>2</sub> 。如果我们在这里采用梯度方向来更新θ，成本函数将会增加。取梯度的负方向将确保我们向最小值移动。一旦我们在![$$ \theta =a $$](img/A448418_1_En_1_Chapter_IEq322.gif)达到最小值，梯度为 0，因此不会进一步更新θ。
...
![$$ C\left({\theta}_1,{\theta}_2\right) = 7{\theta_1}² + 5{\theta_2}² + 4{\theta}_1{\theta}_2 $$](img/A448418_1_En_1_Chapter_Equfx.gif)
...
![$$ a = 7{\theta_1}² + 5{\theta_2}² + 4{\theta}_1{\theta}_2 $$](img/A448418_1_En_1_Chapter_IEq340.gif)代表椭圆。

对于常数 a 的不同值，我们得到不同的椭圆，如图 1-38 所示。特定等高线上的所有点具有相同的函数值。

现在我们知道了什么是等高线图，让我们看看成本函数 C(θ)的等高线图中的梯度下降级数，其中![$$ \theta\ \in\ {\mathrm{\mathbb{R}}}^{2\times 1} $$](img/A448418_1_En_1_Chapter_IEq341.gif)。梯度下降步骤如图 1-39 所示。
...
就拿我们通常的代价函数 C(θ)来说吧，这里![$$ \theta\ \in {\mathrm{\mathbb{R}}}^{n\times 1} $$](img/A448418_1_En_1_Chapter_IEq351.gif)是一个 n 维的模型参数向量。我们可以通过它的二阶泰勒级数展开来近似θ邻域内的代价函数 C(θ)，如下图:
...
沿 x 方向和 y 方向的数据高度相关(见图 1-45 )。协方差矩阵将提供关于数据的所需信息，以减少冗余。我们可以不看 x 和 y 方向，而是看 a <sub>1</sub> 方向，它具有最大的方差。
...
var(z<sub>1</sub>)= var![$$ {a_1}^T\left(x - \mu \right) $$]= a<sub>1</sub><sup>T</sup>cov(x)a<sub>1</sub>表示，其中 var 表示方差，cov(x)表示协方差矩阵。
...
因此，数据沿 a <sub>2</sub> 的方差为 Var(z<sub>2</sub>)= Var![$$ {a_2}^T\left(x - \mu \right) $$]= a<sub>2</sub><sup>T</sup>cov(x)a<sub>2</sub>。
...
a<sub>2</sub>Ta<sub>1</sub>= 0 既然 a <sub>2</sub> 应该与 a <sub>1</sub> 正交。
...
论简化，a<sub>2</sub>Tcov(x)a<sub>1</sub>=![$$ {a_2}^T\lambda {a}_1 = \lambda {a_2}^T{a}_1=0 $$](img/A448418_1_En_1_Chapter_IEq377.gif)。还有，项 2αa<sub>1</sub>Ta<sub>2</sub>等于 0，剩下![$$ \beta {a_1}^T{a}_1=0 $$](img/A448418_1_En_1_Chapter_IEq378.gif)。由于![$$ {a_1}^T{a}_1=1 $$](img/A448418_1_En_1_Chapter_IEq379.gif)，β必须等于 0。
...
因此，我们可以有一个新的成本函数![$$ L\left(\theta \right) = {\left\Vert X\theta\ \hbox{--}\ Y\right\Vert}_2² + \lambda {\left\Vert \theta \right\Vert}_2² $$](img/A448418_1_En_1_Chapter_IEq396.gif)，其中‖θ‖ <sub> 2 </sub> <sup>2</sup> 是模型参数向量的 l <sup>2</sup> 范数的平方。最优化问题变成了

![$$ {\theta}^{*}=\underset{\theta }{\underbrace{Arg\ Min}}\ L\left(\theta \right) = {\left\Vert X\theta\ \hbox{--}\ Y\right\Vert}_2² + \lambda {\left\Vert \theta \right\Vert}_2² $$](img/A448418_1_En_1_Chapter_Equhr.gif)
...
![$$ {\theta}^{*}=\underset{\theta }{\underbrace{Arg\ Min}}\kern0.5em L\left(\theta \right) = {\left\Vert X\theta\ \hbox{--}\ Y\right\Vert}_2² + \lambda {\left\Vert \theta \right\Vert}_1 $$](img/A448418_1_En_1_Chapter_Equhs.gif)
...
![$$ {\theta}^{*}= argmi{n}_{\theta }\ C\left(\theta \right) = {\left\Vert X\theta\ \hbox{--}\ Y\right\Vert}_2² $$](img/A448418_1_En_1_Chapter_Equht.gif)

使得![$$ {\left\Vert \theta \right\Vert}_2²\le b $$](img/A448418_1_En_1_Chapter_IEq399.gif)

其中 b 是常数。

我们可以通过创建一个新的拉格朗日公式，将这个约束极小化问题转化为无约束极小化问题，如下所示:

![$$ L\left(\theta, \lambda \right) = {\left\Vert X\theta\ \hbox{--}\ Y\right\Vert}_2² + \lambda \left({\left\Vert \theta \right\Vert}_2²-b\right) $$](img/A448418_1_En_1_Chapter_Equhu.gif)
...
*   The gradient of Lwith respect to θ;i.e., ![$$ {\nabla}_{\theta }L\left(\theta, \lambda \right) $$](img/A448418_1_En_1_Chapter_IEq400.gif)should be the zero vector, which on simplification gives
    ...
    (1)
*   同样在最优点![$$ \lambda \left({\left\Vert \theta \right\Vert}_2²-b\right) $$](img/A448418_1_En_1_Chapter_IEq401.gif) = 0 和![$$ \lambda\ \ge 0 $$](img/A448418_1_En_1_Chapter_IEq402.gif)如果我们考虑正则化，即![$$ \lambda >0 $$](img/A448418_1_En_1_Chapter_IEq403.gif)，那么![$$ {\left\Vert \theta \right\Vert}_2²-\mathrm{b}=0 $$](img/A448418_1_En_1_Chapter_IEq404.gif) (2)
