...
编码器和解码器共同完成输入数据 *x* 的编码和解码过程。我们将整个网络模型*f*<sub>T5】θ</sub>简称为自编码器。如果使用深度神经网络来参数化![$$ {g}_{\theta_1} $$](img/515226_1_En_12_Chapter_TeX_IEq5.png)和![$$ {h}_{\theta_2} $$](img/515226_1_En_12_Chapter_TeX_IEq6.png)函数，则称为深度自编码器，如图 12-2 所示。
