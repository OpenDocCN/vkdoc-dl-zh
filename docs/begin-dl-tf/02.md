...
对于某个神经元来说， *x* 和 *y* 之间的映射关系*f*<sub>T3】w， *b*</sub> 未知但固定。两点可以确定一条直线。为了估计 *w* 和 *b* 的值，我们只需要从图t】中的直线上采样任意两个数据点(*x*T18】(1)， *y* <sup>(1)</sup> ， *x* <sup>(2)</sup> ， *y* <sup>(2)</sup> )
