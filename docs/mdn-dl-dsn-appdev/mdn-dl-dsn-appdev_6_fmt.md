...
Listing 6-31
Building a model with the scalable architectural policy to determine network widths. We begin reading from the `i+1`th index because the first index contains the input width
