...
![img/516104_1_En_5_Chapter/516104_1_En_5_Fig9_HTML.jpg](img/516104_1_En_5_Chapter/516104_1_En_5_Fig9_HTML.jpg)

**图 5-9** Hyperas 框架的关键组件——数据提供者、目标函数和搜索操作
...
**代码清单 5-14** 在 Hyperas 中优化训练过程的目标函数
...
def obj_func(x_train, y_train, x_test, y_test):
    ...
    import keras.layers as L
    r = lambda x_: 0 if x_ < 0 or x_ > 0.9 else x_
    # import keras layers and sequential model
    from keras.models import Sequential
    import keras.layers as L
...
**代码清单 5-16** 在 Hyperas 中优化架构的目标函数
...
**代码清单 5-17** 通过只定义一个重复使用的 dropout 率，在每个添加的层中使用相同的 dropout 率
...
![img/516104_1_En_5_Chapter/516104_1_En_5_Fig10_HTML.jpg](img/516104_1_En_5_Chapter/516104_1_En_5_Fig10_HTML.jpg)

**图 5-10** 神经架构搜索三个关键组件之间的关系——搜索空间、搜索策略和评估策略
...
![img/516104_1_En_5_Chapter/516104_1_En_5_Fig11_HTML.jpg](img/516104_1_En_5_Chapter/516104_1_En_5_Fig11_HTML.jpg)

**图 5-11** 左边 - 顺序拓扑；右边 - 更复杂的非线性拓扑
