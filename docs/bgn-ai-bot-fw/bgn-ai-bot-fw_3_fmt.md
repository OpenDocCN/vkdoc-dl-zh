...
图 3-40 创建一个新的意图。我们将为聊天机器人创建一个新的意图。
...
图 3-49 选择 Web 演示集成选项。我们正在将机器人集成以启用网页版对话。
