...
对网格世界运行价值算法的输出将产生价值和策略完全相似的最优状态值*v*∫(*s*)和最优策略![$$ {v}_{\pi^{\ast }}\left(a|s\right) $$](../images/502835_1_En_3_Chapter/502835_1_En_3_Chapter_TeX_IEq3.png)，如图 [3-7](#Fig7) 和 [3-8](#Fig8) 所示。
