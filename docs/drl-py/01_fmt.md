...
所有有智慧的生物都是从一些知识开始的。然而，随着他们与世界的互动和经验的积累，他们学会了适应环境，变得更擅长做事。引用 1994 年《华尔街日报》*、<sup>、 1 、</sup>专栏中的一句话，智力可以定义如下:*
...
[`https://en.wikipedia.org/wiki/Mainstream_Science_on_Intelligence`](https://en.wikipedia.org/wiki/Mainstream_Science_on_Intelligence)
