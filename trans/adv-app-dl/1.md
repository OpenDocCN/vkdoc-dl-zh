...
这本书假设你有一些机器学习、神经网络和TensorFlow的基本知识。 <sup>[1](#Fn1)</sup> 这是我的第一本书，*应用深度学习:基于案例的方法* (ISBN 978-1-4842-3790-8)，由 Apress 于 2018 年出版，并假设你知道并理解其中的解释。第一卷的目标是解释神经网络的基本概念，并为您提供深度学习的良好基础，而这本书的目标是解释更高级的主题，如卷积和循环神经网络。为了能够从本书中获益，您至少应该对以下主题有基本的了解:
