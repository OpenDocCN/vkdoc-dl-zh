...
我们需要将图像定义为一个TensorFlow`Variable`(稍后会详细介绍)。如果你不熟悉`tape.gradient`的工作原理，我建议你去 [`https://www.tensorflow.org/tutorials/eager/automatic_differentiation`](https://www.tensorflow.org/tutorials/eager/automatic_differentiation) 查阅官方文档。
